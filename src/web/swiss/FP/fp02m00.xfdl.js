(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("fp01m00","0","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("0");
            obj.set_text("조사현황");
            ...
            obj = new Static("fp02m00","342","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("2");
            obj.set_text("환경설정");
            ...
            obj = new Static("fp03m00","171","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("1");
            obj.set_text("연계결과");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp04m00","513","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("3");
            obj.set_text("정보등록");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp05m00","1026","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("6");
            obj.set_text("결과조회");
            ...
            obj = new Static("fp06m00","684","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("4");
            obj.set_text("결과집계");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp07m00","855","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("5");
            obj.set_text("결과제출");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("Static01_00","500","8","25","25",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("7");
            ...
            obj = new Static("Static01_01","159","8","25","25",null,null,null,null,null,null,this.Div.form.stepArea00_01.form);
            obj.set_taborder("11");
            obj.set_cssclass("ico_step");
            this.Div.form.stepArea00_01.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("fp02m00.xfdl","CM::common.xjs");
        this.addIncludeScript("fp02m00.xfdl","CM::utl_script.xjs");
        this.registerScript("fp02m00.xfdl", function() {
        ...
        this.fp02m00_onload = function(obj,e)
        {
        	...
        	this.fv_SURVPROSTATUSCD = objApp.gds_param.getColumn(0, "SURVPROSTATUSCD");  // 상태코드
        ...
        //selectChargeSchoolList >> selectChargeCompuInfo
        this.selectChargeCompuInfo = function(){
        	...
        	//selectChargeCompuList >> selectChargeCompuInfo
        ...
        this.btn_comyn_onclick = function(obj,e)
        {
        	...
        	//alert(this.Div.form.Div00.form.in_chkBox_00.value);
        ...
        this.btn_save_onclick = function(obj,e)
        {
        	...
        	if(this.Div.form.Div00.form.USERNM.value == null || this.Div.form.Div00.form.USERNM.value == ""){
        		alert("성명을 입력하세요.");
        		this.Div.form.Div00.form.USERNM.setFocus();
        		return;
        	}
        ...
        this.btn_reg_req = function(obj,e)
        {
        	...
        	if( SURVPROSTATUSCD != "4" ){
        		this.alert("취업-학과정보 제출완료 상태에서만 요청할 수 있습니다.");
        		return;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.stepArea00_01.form.fp01m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp02m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp03m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp04m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp05m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp06m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_01.form.fp07m00.addEventHandler("onclick",this.lfn_goMenu,this);
        ...
        this.loadIncludeScript("fp02m00.xfdl");
