(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("fp01m00","0","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("0");
            obj.set_text("조사현황");
            ...
            obj = new Static("fp02m00","342","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("2");
            obj.set_text("환경설정");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp03m00","171","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("1");
            obj.set_text("연계결과");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp04m00","513","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("3");
            obj.set_text("정보등록");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp05m00","1026","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("6");
            obj.set_text("결과조회");
            ...
            obj = new Static("fp06m00","684","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("4");
            obj.set_text("결과집계");
            obj.set_cssclass("step01");
            obj.set_cursor("pointer");
            ...
            obj = new Static("fp07m00","855","0","171","40",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("5");
            obj.set_text("결과제출");
            ...
            obj = new Static("Static01_01_00","671","8","25","25",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("10");
            obj.set_cssclass("ico_step");
            this.Div.form.stepArea00_00_00_00_00_00.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00_00","1013","8","25","25",null,null,null,null,null,null,this.Div.form.stepArea00_00_00_00_00_00.form);
            obj.set_taborder("13");
            obj.set_cssclass("ico_step on02");
            this.Div.form.stepArea00_00_00_00_00_00.addChild(obj.name, obj);

            obj = new Div("sub_research02","30","stepArea00_00_00_00_00_00:20","1200","95",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("7");
            obj.set_text("");
            ...
            obj = new Static("reser_obj02","290","10","123","30",null,null,null,null,null,null,this.Div.form.sub_research02.form);
            obj.set_taborder("2");
            obj.set_text("조사 대상");
            ...
            obj = new Grid("Grid","30","sub_state:5",null,"83","30",null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_binddataset("ds_school_list");
            obj.set_cssclass("grid_sty03_01");
            obj.set_cellsizebandtype("body");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"190\"/><Column size=\"90\"/><Column size=\"264\"/><Column size=\"135\"/><Column size=\"136\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell text=\"학교명\"/><Cell col=\"1\" text=\"본분교명\"/><Cell col=\"2\" text=\"처리상태\"/><Cell col=\"3\" text=\"정보입력일\"/><Cell col=\"4\" text=\"KEDI제출일시\"/></Band><Band id=\"body\"><Cell text=\"bind:SCHNM\"/><Cell col=\"1\" text=\"bind:ORGNM\"/><Cell col=\"2\" text=\"bind:SURVPROSTATUSNM\"/><Cell col=\"3\" text=\"bind:INFOREGDT\"/><Cell col=\"4\" text=\"bind:INFOSENDDT\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("fp07m00.xfdl","CM::common.xjs");
        this.addIncludeScript("fp07m00.xfdl","CM::utl_script.xjs");
        this.registerScript("fp07m00.xfdl", function() {
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	...
        	if(errCD < 0){
        		...
        		if(serviceID == "selectSchoolInfo"){//0915작업분량
        			// 선택된 데이터 불러오기
        			...
        			this.Div.form.sel_box03.form.txt_sh_nm.set_text( SCHNM );
        			this.Div.form.sel_box03.form.txt_sh_or.set_text( ORGNM );
        			*/
        ...
        this.fp07m00_onload = function(obj,e)
        {
        	...
        	if(this.fv_CHANGEYN =="Y"){
        		this.utlf_enableBtn(this.Div,false);
        		/*요청에 의해 화면공유 시 결과 출력 버튼만 활성화 2021-02-01 yyz*/
        		this.Div.form.btn_pub_print.set_enable(true);
        	}
        };
        ...
        this.selectSchoolInfo = function(){
        	...
        	var strParam = "";
        	strParam += "tmp="		        + "a" 		            + "ª";
        	strParam += "STATUSparamCD="    + "0082" 		        + "ª";  // 신입
        ...
        {
        	//this.alert("준비중 입니다.");
        	/*   결과출력은 조사기간에 상관없이 출력되도록 요청 2021-02-10 yyz
        	...
        	*/
        	...
        	if(  SURVPROSTATUSCD != "11" &&  SURVPROSTATUSCD != "12"  ){
        		...
        		var fnm = "freshCntNew.mrd";
        		//var param = "SURVSEQ[201231] SURVKINDCD[AG] SCHCD[53168000] ORGCD[1]";
        		var param = "SURVSEQ["+SURVSEQ+"] SURVKINDCD["+SURVKINDCD+"] SCHCD["+SCHCD+"] ORGCD["+ORGCD+"]";
        		var objFrame = new ChildFrame();
        		...
        		//objFrame.set_formurl( "FP::fp07p00.xfdl" );
        ...
        this.btn_con_onclick = function(obj,e)
        {
        	...
        	*/
        	...
        	var CHGCOMYN = this.ds_school_list.getColumn(this.ds_school_list.rowposition,"CHGCOMYN");
        	var SURVPROSTATUSCD = this.ds_school_list.getColumn(this.ds_school_list.rowposition,"SURVPROSTATUSCD");
        	//alert(SURVPROSTATUSCD);
        	...
        	// 다타입
        		if( SURVPROSTATUSCD != "9"   ){
        			this.alert("제출 가능한 상태가 아닙니다. 전산담당자가 제출한 신입생정보 승인 이후 제출이 가능합니다.");
        			return;
        		}
        	}else{
        	// 나타입
        		if( SURVPROSTATUSCD != "7"   ){
        			this.alert("제출 가능한 상태가 아닙니다. 신입생정보 등록 이후 제출이 가능합니다.");
        			return;
        		}
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.stepArea00_00_00_00_00_00.form.fp01m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp02m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp03m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp04m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp05m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp06m00.addEventHandler("onclick",this.lfn_goMenu,this);
            this.Div.form.stepArea00_00_00_00_00_00.form.fp07m00.addEventHandler("onclick",this.lfn_goMenu,this);
        ...
        this.loadIncludeScript("fp07m00.xfdl");
