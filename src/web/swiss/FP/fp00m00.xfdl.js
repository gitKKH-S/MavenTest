(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_image("url(\'theme::default/images/img_researchTop02.jpg\')");
            ...
            obj.set_image("url(\'theme::default/images/reser_table02.png\')");
            this.Div.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer01","30","600","1200","180",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_background("transparent");
            obj.set_image("url(\'theme::default/images/reser_visual02.jpg\')");
            this.Div.addChild(obj.name, obj);

            obj = new Static("Static03","770","Div00:0","30","13",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            obj.set_background("url(\'theme::default/images/reser_bul02.png\') no-repeat");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("fp00m00.xfdl","CM::common.xjs");
        this.registerScript("fp00m00.xfdl", function() {
        ...
        this.Div_Div00_Static01_onclick = function(obj,e)
        {

        };

        this.Div_ImageViewer00_onclick = function(obj,e)
        {
        ...
        {
            this.Div.form.Div00.form.Static01.addEventHandler("onclick",this.Div_Div00_Static01_onclick,this);
            this.Div.form.ImageViewer00.addEventHandler("onclick",this.Div_ImageViewer00_onclick,this);
        };

        this.loadIncludeScript("fp00m00.xfdl");
