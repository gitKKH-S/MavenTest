(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("imgNews","30","0","1200","160",null,null,null,null,null,null,this.div_AreaMain.form);
            ...
            obj = new Div("div_AreaContent","31","imgNews:30","1200","620",null,null,null,null,null,null,this.div_AreaMain.form);
            obj.set_taborder("2");
            obj.set_cssclass("rowGrid");
            obj.set_text("");
            this.div_AreaMain.addChild(obj.name, obj);

            obj = new Div("div_areaTitle","-1","0","1197","51",null,null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form);
            obj.set_taborder("0");
            ...
            obj = new Static("label_subject","div_subTitle:20","0","701","50",null,null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form.div_areaTitle.form);
            obj.set_taborder("1");
            ...
            obj.set_border("0px none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"645\"/><Column size=\"250\"/><Column size=\"103\"/></Columns><Rows><Row size=\"40\"/></Rows><Band id=\"body\"><Cell text=\"bind:REAL_FILE_NAME\" border=\"0px none\"/><Cell col=\"1\" text=\"bind:FILE_SIZE\" border=\"0px none\"/><Cell col=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"다운로드\" cssclass=\"cellBtn\" border=\"0px none\"/></Band></Format></Formats>");
            this.div_AreaMain.form.div_AreaContent.form.div_fileArea.addChild(obj.name, obj);
            ...
            obj = new Static("label_workerNm","198","0","482","51",null,null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form.div_writeArea.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static00_01_01_00","680","0","155","51",null,null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form.div_writeArea.form);
            obj.set_taborder("3");
            obj.set_text("작성일시");
            ...
            obj = new Static("label_workDthm","Static00_01_01_00:0","0",null,"51","0",null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form.div_writeArea.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static00_00_00","0","0","200","51",null,null,null,null,null,null,this.div_AreaMain.form.div_AreaContent.form.div_writeArea.form);
            obj.set_taborder("2");
            obj.set_text("작성자");
            obj.set_cssclass("boxTitleBlue");
            obj.set_textAlign("center");
            ...
            obj = new BindItem("item0","div_AreaMain.form.div_AreaContent.form.div_areaTitle.form.label_subject","text","ds_notice","SUBJECT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","div_AreaMain.form.div_AreaContent.form.div_writeArea.form.label_workerNm","text","ds_notice","WORKERID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","div_AreaMain.form.div_AreaContent.form.div_writeArea.form.label_workDthm","text","ds_notice","WORKDTHM");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("hp01m02.xfdl","CM::common.xjs");
        this.registerScript("hp01m02.xfdl", function() {
        ...
        this.fv_MENUNM = "알림소식>공지사항>상세";
        this.fv_SURVSEQ="";
        this.fv_SURVKINDCD="AG";
        var objApp 		= nexacro.getApplication();

        this.hp01m02_oninit = function(obj,e)
        {
        ...
        this.selectNoticeView = function(){
        	...
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "상세정보", strParam);  //공지상세조회
        ...
        this.Div_btn_del_onclick = function(obj,e)
        {
        	if(confirm("내용을 삭제하시겠습니까?")){
        		...
        		dsParamSetArrowBlank(this.ds_search, strParam);
        		this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "삭제", strParam);  //공지삭제
        		this.gfnTransaction("deleteNotice",
        							"swiss/hp/notice/deleteNotice.do",
        							"dsSearch=ds_search",
        							"",
        							"",
        							"fnCallback",
        ...
        this.selectFileList = function(){
        	...
        	var fileId = this.ds_notice.getColumn(0, "FILEID")

        	var strParam = "ATT_IDT_NO=" + fileId + "ª";

        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "첨부파일 리스트 조회", strParam);
        ...
        {
        	obj.callMethod("setContent", this.ds_notice.getColumn(0, "TEXT"));
        	/* 높이계산
        	...
        	trace("===" + viewHeight);
        	this.div_AreaMain.set_height(viewHeight);
        	this.div_AreaMain.form.div_AreaContent.set_height(viewHeight);
        	this.div_AreaMain.form.div_AreaContent.form.div_areaText.set_height(viewHeight);
        	this.div_AreaMain.form.div_AreaContent.form.div_areaText.form.webBrower_text.set_height(viewHeight);
        	*/
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "selectNoticeView"){
        			this.div_AreaMain.form.div_AreaContent.form.div_areaTitle.form.div_subTitle.set_text(this.ds_notice.getColumn(0,"SURVYEAR") + "년 " + this.ds_notice.getColumn(0,"SURVKINDNM"));
        			this.div_AreaMain.form.div_AreaContent.form.div_writeArea.form.label_workerNm.set_text(this.ds_notice.getColumn(0,"DEPTNM") + " " + this.ds_notice.getColumn(0,"WORKERNM"))

        			var url = nexacro.getEnvironment().services["svcBaseUrl"].url;
        			this.div_AreaMain.form.div_AreaContent.form.div_areaText.form.webBrower_text.set_url(url + "ui/file/richtexteditor/html/preview.html");

        			this.fileDownTrans.setPostData("BASE_DIR", "");
        			this.fileDownTrans.set_url(url + "swiss/hp/com/downloadFile.do");
        			this.selectFileList();
        		}
        ...
        //웹 브라우저 내 jsp정상 load체크			1/2
        this.webBrower_fileList_onloadcompleted = function(obj:nexacro.WebBrowser,e:nexacro.WebLoadCompEventInfo)
        {
        	trace("STATE 11 : " + this.onloadChk);
        	this.onloadChk = true;
        	trace("STATE 2 : " + this.onloadChk);
        	this.fn_fileListChk();
        };
        ...
        this.fn_fileListChk = function(){
        	trace("STATE 3 : " + this.onloadChk);

        	if(this.onloadChk){
        		trace("STATE : 동작");
        		var _win = this.webBrower_fileList.callMethod("fileListCheck",14,"BOARD");
        	}else{
        ...
        */
        ...
        {
            this.addEventHandler("oninit",this.hp01m02_oninit,this);
            ...
            this.div_AreaMain.form.div_AreaContent.form.div_areaText.form.webBrower_text.addEventHandler("onusernotify",this.div_AreaMain_div_AreaContent_div_areaText_webBrower_text_onusernotify,this);
        ...
        this.loadIncludeScript("hp01m02.xfdl");
