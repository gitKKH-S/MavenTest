(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("imgreFer","0","0","1200","160",null,null,null,null,null,null,this.Div.form.div_areaTitleImg.form);
            ...
            obj = new Grid("gd_pds_list","30","div_00:10","1200","445",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_autofittype("col");
            obj.set_binddataset("ds_pds");
            obj.set_cssclass("default");
            obj.set_scrollbartype("auto auto");
            obj.set_wheelscrollrow("1");
            obj.set_nodatatext("데이터가 없습니다.");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"604\"/><Column size=\"60\"/><Column size=\"65\"/><Column size=\"110\"/><Column size=\"105\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"조사년도\"/><Cell col=\"2\" text=\"조사종류\"/><Cell col=\"3\" text=\"제목\"/><Cell col=\"4\" text=\"첨부\"/><Cell col=\"5\" text=\"조회수\"/><Cell col=\"6\" text=\"작성자\"/><Cell col=\"7\" text=\"작성일\" border=\"0px none,0px none,1px solid #a5a5a5\"/></Band><Band id=\"body\"><Cell text=\"expr:RNUM == '0' ? '공지' :RNUM\" cssclass=\"c_red\" color=\"#000000\"/><Cell col=\"1\" text=\"bind:SURVYEAR\"/><Cell col=\"2\" text=\"bind:SURVKINDNM\"/><Cell col=\"3\" text=\"bind:SUBJECT\" cssclass=\"alignLeft\"/><Cell col=\"4\" displaytype=\"expr:FILEYN == '1' ? 'imagecontrol' : 'none'\" text=\"expr:FILEYN == '1'? &quot;url('theme://images/ico_file.png')&quot; : &quot;&quot;\"/><Cell col=\"5\" text=\"bind:HIT\"/><Cell col=\"6\" text=\"bind:WORKERNM\"/><Cell col=\"7\" text=\"bind:WORKDTHM\" calendardateformat=\"yyyy.MM.dd\" displaytype=\"date\" border=\"1px solid #dbdee2\" calendareditformat=\"yyyy.MM.dd\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);

            obj = new Div("pagingWrap","30","gd_pds_list:10","1200","60",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("4");
            obj.set_text("");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("hp03m00_copy0.xfdl","CM::common.xjs");
        this.registerScript("hp03m00_copy0.xfdl", function() {
        this.executeIncludeScript("CM::common.xjs"); /*include "CM::common.xjs"*/;

        this.pageRowCnt = 20;
        this.totalRowCnt = 0;
        this.fv_MENUNM = "알림소식>자료실";
        this.fv_SURVSEQ="";
        ...
        // 상세페이지 연결
        this.Div_gd_pds_list_oncellclick = function(obj,e)
        {
        	var rowPos = this.Div.form.gd_pds_list.getSelectedRows();
        	var bbsNo = this.ds_pds.getColumn(rowPos, "BBSNO");

        	var strParam = "BBSNO=" + bbsNo + "ª";

        	dsParamSetArrowBlank(nexacro.getApplication().gds_rtn_result, strParam);

        	this.fn_goPage("HP::hp03m02.xfdl");
        };
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "searchPdsCnt"){
        			this.totalRowCnt = this.ds_cnt.getColumn(0, "CNT");
        			this.paggingInit();
        			this.searchPdsList(Number(this.Div.form.pagingWrap.form.div_pagging.form.fv_pageIdx+1));
        		}
        	}
        }
        ...
        this.searchPdsCnt = function(){
        	...
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "검색", strParam);  //자료실 검색
        	this.gfnTransaction("searchPdsCnt",
        						"swiss/hp/pds/searchPdsCnt.do",
        						"dsSearch=ds_search",
        						"ds_cnt=dsResult",
        						"",
        						"fnCallback",
        ...
        // 데이터 가져오기
        this.searchPdsList = function(sPage){
        	var year = this.Div.form.sub_search.form.in_cb_year.value;
        	var kindcd = this.Div.form.sub_search.form.in_cb_kind.value;
        	var keyword = this.Div.form.sub_search.form.in_edit_keyword.value;
        	var workernm = this.Div.form.sub_search.form.in_chkBox_name.value;
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("searchPdsList",
        						"swiss/hp/pds/searchPdsList.do",
        						"dsSearch=ds_search",
        						"ds_pds=dsResult",
        						"",
        						"fnCallback",
        	...
        	/*
        	var cnt = this.ds_pds.getRowCount();
        	if(cnt > 10){
        		this.Div.form.gd_pds_list.set_height(Number(Number(cnt*40)+Number(50)));
        	} else {
        		this.Div.form.gd_pds_list.set_height(445);
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.gd_pds_list.addEventHandler("oncellclick",this.Div_gd_pds_list_oncellclick,this);
        };

        this.loadIncludeScript("hp03m00_copy0.xfdl");
