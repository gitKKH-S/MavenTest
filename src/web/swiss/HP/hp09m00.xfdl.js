(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1260,1340);
            }
            ...
            obj = new Div("Div","0","0","1260","1210",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00_00","1230","0","30","1290",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new WebBrowser("WebBrowser00","30","530","1202","660",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("7");
            obj.set_border("0");
            this.Div.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,1340,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("hp09m00.xfdl","CM::common.xjs");
        this.registerScript("hp09m00.xfdl", function() {
        ...
        */
        ...
        this.hp09m00_oninit = function(obj,e)
        {
        	var svcBaseUrl = nexacro.getEnvironment().services["svcBaseUrl"].url;
        	this.Div.form.WebBrowser00.set_url( svcBaseUrl + "swiss/login/smsLoginId.do");
        ...
        {
            this.addEventHandler("oninit",this.hp09m00_oninit,this);
            ...
            this.Div.form.btn_epki.addEventHandler("ondblclick",this.Div.form.btn_epki_onclick,this);
        ...
        this.loadIncludeScript("hp09m00.xfdl");
