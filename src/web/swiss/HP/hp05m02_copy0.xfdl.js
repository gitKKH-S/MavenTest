(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_displaynulltext("답변을 작성해주세요.      최대5줄까지 입력됩니다.");
        ...
        // User Script
        this.addIncludeScript("hp05m02_copy0.xfdl","CM::common.xjs");
        this.registerScript("hp05m02_copy0.xfdl", function() {
        ...
        */
        ...
        this.replyListCreate = function(){
        	...
        	if(cnt > 0){
        		...
        		for(var i=0; cnt > i; i++){
        			...
        			var chkHeight = 0;
        			chkHeight = 10+chkRow*20;

        			var replyHeight = 10+chkRow*20+250;

        			var plusH = i * replyHeight;

        			alert("i="+i+",chkRow="+chkRow+", chkHeight="+chkHeight+", replyHeight="+replyHeight+", plusH="+plusH);
        ...
        this.loadIncludeScript("hp05m02_copy0.xfdl");
