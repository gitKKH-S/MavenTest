(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1260,1320);
            }
            ...
            obj = new WebBrowser("WebBrowser00","30","490","1200","700",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            obj.set_border("0");
            this.Div.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,1320,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("hp10m01.xfdl","CM::common.xjs");
        this.registerScript("hp10m01.xfdl", function() {
        ...
        */
        ...
        this.hp10m01_oninit = function(obj,e)
        {
        	//alert(1);
        	var svcBaseUrl = nexacro.getEnvironment().services["svcBaseUrl"].url;
        	this.Div.form.WebBrowser00.set_url(svcBaseUrl + "swiss/login/epkiAuthRegEnd.do");
        ...
        {
            this.addEventHandler("oninit",this.hp10m01_oninit,this);
        ...
        this.loadIncludeScript("hp10m01.xfdl");
