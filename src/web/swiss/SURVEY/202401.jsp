...
<head>
	...
	<STYLE>
		...
		.DESC_BOX { BORDER:1PX SOLID BLACK; PADDING:10PX; background:#e5e5e5; font-weight:bold; }
		...
		.td2 { text-align: left !important; WIDTH:50%; VERTICAL-ALIGN:TOP; }
		
		.QUESTION_TITLE { FONT-WEIGHT:BOLD; text-align:left; }
	</STYLE>
	
	<SCRIPT>
	function td_clk(ins_id){
		//window.alert("ins_id="+ins_id);
		$("#"+ins_id).prop('checked',true);
	}
	...
	function modify_survey(){
		...
		$.ajax({
			...
			success : function(result){
				//$("#formStatus").val('success');
				//alert("success");
				call_modal('설문 제출이 완료되었습니다.','');
				//alert(1);
	...
	function call_modal(ins_msg,ins_opt){
		$("#modal_body").html(ins_msg);
		$('#myModal').modal("show");
	}
	
	function call_nexacro(){
		if(window.NEXACROWEBBROWSER){
			window.alert("IN CALL NEXA 1");
			
			webBrower_queInqList.on_fire_onusernotify(window.NEXACROWEBBROWSER, "");
		}else{
			window.alert("IN CALL NEXA 2");
		}
	}
	...
	function chk_Form(){
		...
		if(!chk_q1_1){
			call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
			//call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
		...
		if(!chk_q9){
			...
			switch(chk_q9){
				case "1":
					...
					var chk_q9_2_2 = $(":input[name=q9_2]").val().trim();
					//alert("chk_q9_1_2=["+chk_q9_1_2+"]");
					if(!chk_q9_2_2){
						call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
						$("#label_q9_2_2").css('color','red');
						offset = $("#label_q9_2_2").offset(); //í´ë¹ ìì¹ ë°í
						$("html, body").animate({scrollTop: offset.top},400);
						return false;
					}else{
						$("#label_q9_2_2").css('color','black');
					}
					/*
					var chk_q9_2_3 = $(":input[name=q9_3]").val().trim();
					//alert("chk_q9_2_3=["+chk_q9_2_3+"]");
					if(!chk_q9_2_3){
						call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
						$("#label_q9_2_3").css('color','red');
						offset = $("#label_q9_2_3").offset(); //í´ë¹ ìì¹ ë°í
						$("html, body").animate({scrollTop: offset.top},400);
						return false;
					}else{
						$("#label_q9_2_3").css('color','black');
					}
					*/
					break;
				case "2":
		...
		if(!chk_q10){
			...
			switch(chk_q10){
				case "1":
					...
					var chk_q10_2_2 = $(":input[name=q10_2]").val().trim();
					//alert("chk_q10_2_2=["+chk_q10_2_2+"]");
					if(!chk_q10_2_2){
						call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
						$("#label_q10_2_2").css('color','red');
						offset = $("#label_q10_2_2").offset(); //í´ë¹ ìì¹ ë°í
						$("html, body").animate({scrollTop: offset.top},400);
						return false;
					}else{
						$("#label_q10_2_2").css('color','black');
					}
					/*
					var chk_q10_2_3 = $(":input[name=q10_3]").val().trim();
					//alert("chk_q10_2_3=["+chk_q10_2_3+"]");
					if(!chk_q10_2_3){
						call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
						$("#label_q10_2_3").css('color','red');
						offset = $("#label_q10_2_3").offset(); //í´ë¹ ìì¹ ë°í
						$("html, body").animate({scrollTop: offset.top},400);
						return false;
					}else{
						$("#label_q10_2_3").css('color','black');
					}
					*/
					break;
				case "2":
...
/*
		var chk_q12_1 = $(":input[name=q12_1]").val().trim();
		//alert("chk_q12=["+chk_q12+"]");
		if(!chk_q12_1){
			call_modal('응답하지 않은 설문이 있습니다.<br>붉은색으로 표시된 설문을 확인해주세요','');
			$("#label_q12_1").css('color','red');
			offset = $("#label_q12_1").offset(); //í´ë¹ ìì¹ ë°í
			$("html, body").animate({scrollTop: offset.top},400);
			return false;
		}else{
			$("#label_q12_1").css('color','black');
		}
*/	
		return true;
	...
	<div class="container">
	  <div class="panel panel-default">
	    <div class="panel-body" style="background:#f5f5f5; font-weight:bold; font-size:16px;">
			...
			2023년도 고등교육기관 졸업자 취업통계조사를 위한 졸업후상황 조사에 임해주신 취업통계 담당자분들께 감사의 말씀을 드립니다.<br>
			한국교육개발원 고등교육 취업통계팀에서는 취업통계조사 및 시스템의 개선방안 마련을 위해 취업통계 담당자분들의 의견을 수렴하고자 합니다.<br>
			바쁘시더라도 조사에 협조 부탁드립니다.<br>
			감사합니다.<BR><br>
			◎ 설문조사 기간 : 2024.04.01.(월) ~ 2024.04.26.(금)
	    </div>
	  </div>
	</DIV>	
	
<div class="container max-width no-padding">
  <div class="panel panel-success" STYLE="BACKGROUND:;">
  ...
  <div class="panel panel-success">
    ...
    <div class="panel-body">
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						...
						<TD onclick="javascript:td_clk('q2_1_1');"><input class="form-check-input" type="radio" name="q2_1" value="1" id="q2_1_1"></TD>
						<TD onclick="javascript:td_clk('q2_1_2');"><input class="form-check-input" type="radio" name="q2_1" value="2" id="q2_1_2"></TD>
						<TD onclick="javascript:td_clk('q2_1_3');"><input class="form-check-input" type="radio" name="q2_1" value="3" id="q2_1_3"></TD>
						<TD onclick="javascript:td_clk('q2_1_4');"><input class="form-check-input" type="radio" name="q2_1" value="4" id="q2_1_4"></TD>
						<TD onclick="javascript:td_clk('q2_1_5');"><input class="form-check-input" type="radio" name="q2_1" value="5" id="q2_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q2_2"><SPAN CLASS="QUESTION_NO">2-2.</SPAN>지침서가 내용을 이해하기 쉽게 기술되어 있습니까?</TD>
						<TD onclick="javascript:td_clk('q2_2_1');"><input class="form-check-input" type="radio" name="q2_2" value="1" id="q2_2_1"></TD>
						<TD onclick="javascript:td_clk('q2_2_2');"><input class="form-check-input" type="radio" name="q2_2" value="2" id="q2_2_2"></TD>
						<TD onclick="javascript:td_clk('q2_2_3');"><input class="form-check-input" type="radio" name="q2_2" value="3" id="q2_2_3"></TD>
						<TD onclick="javascript:td_clk('q2_2_4');"><input class="form-check-input" type="radio" name="q2_2" value="4" id="q2_2_4"></TD>
						<TD onclick="javascript:td_clk('q2_2_5');"><input class="form-check-input" type="radio" name="q2_2" value="5" id="q2_2_5"></TD>
					</TR>
					<TR>
		...
		<DIV CLASS="QUESTION_TITLE" id="label_q3_1">
			<SPAN CLASS="QUESTION_NO">3-1.</SPAN>취업통계조사 연수에 참석하였습니까?
		</DIV>
		<DIV CLASS="QUESTION_OBJECT">
		...
		<div id="q3_1_t1" style="display:none;">	
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						<TD class="td2" id="label_q3_1_1"><SPAN CLASS="QUESTION_NO">3-1-1.</SPAN>연수가 취업통계조사 시 도움이 되었습니까?</TD>
						<TD onclick="javascript:td_clk('3_1_1_1');"><input class="form-check-input" type="radio" name="q3_1_1" value="1" id="q3_1_1_1"></TD>
						<TD onclick="javascript:td_clk('3_1_1_2');"><input class="form-check-input" type="radio" name="q3_1_1" value="2" id="q3_1_1_2"></TD>
						<TD onclick="javascript:td_clk('3_1_1_3');"><input class="form-check-input" type="radio" name="q3_1_1" value="3" id="q3_1_1_3"></TD>
						<TD onclick="javascript:td_clk('3_1_1_4');"><input class="form-check-input" type="radio" name="q3_1_1" value="4" id="q3_1_1_4"></TD>
						<TD onclick="javascript:td_clk('3_1_1_5');"><input class="form-check-input" type="radio" name="q3_1_1" value="5" id="q3_1_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q3_1_2"><SPAN CLASS="QUESTION_NO">3-1-2.</SPAN>연수 발표자료가 취업통계조사 시 도움이 되었습니까?</TD>
						<TD onclick="javascript:td_clk('3_1_2_1');"><input class="form-check-input" type="radio" name="q3_1_2" value="1" id="q3_1_2_1"></TD>
						<TD onclick="javascript:td_clk('3_1_2_2');"><input class="form-check-input" type="radio" name="q3_1_2" value="2" id="q3_1_2_2"></TD>
						<TD onclick="javascript:td_clk('3_1_2_3');"><input class="form-check-input" type="radio" name="q3_1_2" value="3" id="q3_1_2_3"></TD>
						<TD onclick="javascript:td_clk('3_1_2_4');"><input class="form-check-input" type="radio" name="q3_1_2" value="4" id="q3_1_2_4"></TD>
						<TD onclick="javascript:td_clk('3_1_2_5');"><input class="form-check-input" type="radio" name="q3_1_2" value="5" id="q3_1_2_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q3_1_3"><SPAN CLASS="QUESTION_NO">3-1-3.</SPAN>연수 녹화영상이 취업통계조사 시 도움이 되었습니까?</TD>
						<TD onclick="javascript:td_clk('3_1_3_1');"><input class="form-check-input" type="radio" name="q3_1_3" value="1" id="q3_1_3_1"></TD>
						<TD onclick="javascript:td_clk('3_1_3_2');"><input class="form-check-input" type="radio" name="q3_1_3" value="2" id="q3_1_3_2"></TD>
						<TD onclick="javascript:td_clk('3_1_3_3');"><input class="form-check-input" type="radio" name="q3_1_3" value="3" id="q3_1_3_3"></TD>
						<TD onclick="javascript:td_clk('3_1_3_4');"><input class="form-check-input" type="radio" name="q3_1_3" value="4" id="q3_1_3_4"></TD>
						<TD onclick="javascript:td_clk('3_1_3_5');"><input class="form-check-input" type="radio" name="q3_1_3" value="5" id="q3_1_3_5"></TD>
					</TR>			
					<TR>
		...
		<DIV CLASS="QUESTION_OBJECT">
			...
			<input class="form-check-input" type="radio" name="q3_2" value="3" id="q3_2_3" style="margin-left:20px;">
			<label class="form-check-label" for="q3_2_3">비대면 연수, 대면 연수 병행</label>				
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						...
						<TD onclick="javascript:td_clk('q4_1_1');"><input class="form-check-input" type="radio" name="q4_1" value="1" id="q4_1_1"></TD>
						<TD onclick="javascript:td_clk('q4_1_2');"><input class="form-check-input" type="radio" name="q4_1" value="2" id="q4_1_2"></TD>
						<TD onclick="javascript:td_clk('q4_1_3');"><input class="form-check-input" type="radio" name="q4_1" value="3" id="q4_1_3"></TD>
						<TD onclick="javascript:td_clk('q4_1_4');"><input class="form-check-input" type="radio" name="q4_1" value="4" id="q4_1_4"></TD>
						<TD onclick="javascript:td_clk('q4_1_5');"><input class="form-check-input" type="radio" name="q4_1" value="5" id="q4_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q4_2"><SPAN CLASS="QUESTION_NO">4-2.</SPAN>문의에 관한 해결이 신속하게 처리되었습니까?</TD>
						<TD onclick="javascript:td_clk('q4_2_1');"><input class="form-check-input" type="radio" name="q4_2" value="1" id="q4_2_1"></TD>
						<TD onclick="javascript:td_clk('q4_2_2');"><input class="form-check-input" type="radio" name="q4_2" value="2" id="q4_2_2"></TD>
						<TD onclick="javascript:td_clk('q4_2_3');"><input class="form-check-input" type="radio" name="q4_2" value="3" id="q4_2_3"></TD>
						<TD onclick="javascript:td_clk('q4_2_4');"><input class="form-check-input" type="radio" name="q4_2" value="4" id="q4_2_4"></TD>
						<TD onclick="javascript:td_clk('q4_2_5');"><input class="form-check-input" type="radio" name="q4_2" value="5" id="q4_2_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q4_3"><SPAN CLASS="QUESTION_NO">4-3.</SPAN>응대직원의 태도는 친절하였습니까?</TD>
						<TD onclick="javascript:td_clk('q4_3_1');"><input class="form-check-input" type="radio" name="q4_3" value="1" id="q4_3_1"></TD>
						<TD onclick="javascript:td_clk('q4_3_2');"><input class="form-check-input" type="radio" name="q4_3" value="2" id="q4_3_2"></TD>
						<TD onclick="javascript:td_clk('q4_3_3');"><input class="form-check-input" type="radio" name="q4_3" value="3" id="q4_3_3"></TD>
						<TD onclick="javascript:td_clk('q4_3_4');"><input class="form-check-input" type="radio" name="q4_3" value="4" id="q4_3_4"></TD>
						<TD onclick="javascript:td_clk('q4_3_5');"><input class="form-check-input" type="radio" name="q4_3" value="5" id="q4_3_5"></TD>
					</TR>			
					<TR>
						<TD class="td2" id="label_q4_4"><SPAN CLASS="QUESTION_NO">4-4.</SPAN>응대직원의 전문지식과 업무능력은 적절하였습니까?</TD>
						<TD onclick="javascript:td_clk('q4_4_1');"><input class="form-check-input" type="radio" name="q4_4" value="1" id="q4_4_1"></TD>
						<TD onclick="javascript:td_clk('q4_4_2');"><input class="form-check-input" type="radio" name="q4_4" value="2" id="q4_4_2"></TD>
						<TD onclick="javascript:td_clk('q4_4_3');"><input class="form-check-input" type="radio" name="q4_4" value="3" id="q4_4_3"></TD>
						<TD onclick="javascript:td_clk('q4_4_4');"><input class="form-check-input" type="radio" name="q4_4" value="4" id="q4_4_4"></TD>
						<TD onclick="javascript:td_clk('q4_4_5');"><input class="form-check-input" type="radio" name="q4_4" value="5" id="q4_4_5"></TD>
					</TR>			
					<TR>
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				...
				<TR>
					...
					<TD onclick="javascript:td_clk('q5_1_1');"><input class="form-check-input" type="radio" name="q5_1" value="1" id="q5_1_1"></TD>
					<TD onclick="javascript:td_clk('q5_1_2');"><input class="form-check-input" type="radio" name="q5_1" value="2" id="q5_1_2"></TD>
					<TD onclick="javascript:td_clk('q5_1_3');"><input class="form-check-input" type="radio" name="q5_1" value="3" id="q5_1_3"></TD>
					<TD onclick="javascript:td_clk('q5_1_4');"><input class="form-check-input" type="radio" name="q5_1" value="4" id="q5_1_4"></TD>
					<TD onclick="javascript:td_clk('q5_1_5');"><input class="form-check-input" type="radio" name="q5_1" value="5" id="q5_1_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q5_2"><SPAN CLASS="QUESTION_NO">5-2.</SPAN>시스템 오류나 장애 발생 시 바로 조치 되고 있습니까?</TD>
					<TD onclick="javascript:td_clk('q5_1_1');"><input class="form-check-input" type="radio" name="q5_2" value="1" id="q5_2_1"></TD>
					<TD onclick="javascript:td_clk('q5_2_2');"><input class="form-check-input" type="radio" name="q5_2" value="2" id="q5_2_2"></TD>
					<TD onclick="javascript:td_clk('q5_2_3');"><input class="form-check-input" type="radio" name="q5_2" value="3" id="q5_2_3"></TD>
					<TD onclick="javascript:td_clk('q5_2_4');"><input class="form-check-input" type="radio" name="q5_2" value="4" id="q5_2_4"></TD>
					<TD onclick="javascript:td_clk('q5_2_5');"><input class="form-check-input" type="radio" name="q5_2" value="5" id="q5_2_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q5_3"><SPAN CLASS="QUESTION_NO">5-3.</SPAN>조사시스템의 응답 속도는 만족할 수준입니까?</TD>
					<TD onclick="javascript:td_clk('q5_3_1');"><input class="form-check-input" type="radio" name="q5_3" value="1" id="q5_3_1"></TD>
					<TD onclick="javascript:td_clk('q5_3_2');"><input class="form-check-input" type="radio" name="q5_3" value="2" id="q5_3_2"></TD>
					<TD onclick="javascript:td_clk('q5_3_3');"><input class="form-check-input" type="radio" name="q5_3" value="3" id="q5_3_3"></TD>
					<TD onclick="javascript:td_clk('q5_3_4');"><input class="form-check-input" type="radio" name="q5_3" value="4" id="q5_3_4"></TD>
					<TD onclick="javascript:td_clk('q5_3_5');"><input class="form-check-input" type="radio" name="q5_3" value="5" id="q5_3_5"></TD>
				</TR>			
			</TABLE>	
		</div>
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				...
				<TR>
					...
					<TD onclick="javascript:td_clk('q6_1_1');"><input class="form-check-input" type="radio" name="q6_1" value="1" id="q6_1_1"></TD>
					<TD onclick="javascript:td_clk('q6_1_2');"><input class="form-check-input" type="radio" name="q6_1" value="2" id="q6_1_2"></TD>
					<TD onclick="javascript:td_clk('q6_1_3');"><input class="form-check-input" type="radio" name="q6_1" value="3" id="q6_1_3"></TD>
					<TD onclick="javascript:td_clk('q6_1_4');"><input class="form-check-input" type="radio" name="q6_1" value="4" id="q6_1_4"></TD>
					<TD onclick="javascript:td_clk('q6_1_5');"><input class="form-check-input" type="radio" name="q6_1" value="5" id="q6_1_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q6_2"><SPAN CLASS="QUESTION_NO">6-2.</SPAN>조사시스템에 필요한 정보가 시의적절하게 제공되고 있습니까?</TD>
					<TD onclick="javascript:td_clk('q6_2_1');"><input class="form-check-input" type="radio" name="q6_2" value="1" id="q6_2_1"></TD>
					<TD onclick="javascript:td_clk('q6_2_2');"><input class="form-check-input" type="radio" name="q6_2" value="2" id="q6_2_2"></TD>
					<TD onclick="javascript:td_clk('q6_2_3');"><input class="form-check-input" type="radio" name="q6_2" value="3" id="q6_2_3"></TD>
					<TD onclick="javascript:td_clk('q6_2_4');"><input class="form-check-input" type="radio" name="q6_2" value="4" id="q6_2_4"></TD>
					<TD onclick="javascript:td_clk('q6_2_5');"><input class="form-check-input" type="radio" name="q6_2" value="5" id="q6_2_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q6_3"><SPAN CLASS="QUESTION_NO">6-3.</SPAN>조사시스템에서 제공되는 정보는 활용성이 높습니까?</TD>
					<TD onclick="javascript:td_clk('q6_3_1');"><input class="form-check-input" type="radio" name="q6_3" value="1" id="q6_3_1"></TD>
					<TD onclick="javascript:td_clk('q6_3_2');"><input class="form-check-input" type="radio" name="q6_3" value="2" id="q6_3_2"></TD>
					<TD onclick="javascript:td_clk('q6_3_3');"><input class="form-check-input" type="radio" name="q6_3" value="3" id="q6_3_3"></TD>
					<TD onclick="javascript:td_clk('q6_3_4');"><input class="form-check-input" type="radio" name="q6_3" value="4" id="q6_3_4"></TD>
					<TD onclick="javascript:td_clk('q6_3_5');"><input class="form-check-input" type="radio" name="q6_3" value="5" id="q6_3_5"></TD>
				</TR>			
			</TABLE>
		</div>
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				...
				<TR>
					...
					<TD onclick="javascript:td_clk('q7_1_1');"><input class="form-check-input" type="radio" name="q7_1" value="1" id="q7_1_1"></TD>
					<TD onclick="javascript:td_clk('q7_1_2');"><input class="form-check-input" type="radio" name="q7_1" value="2" id="q7_1_2"></TD>
					<TD onclick="javascript:td_clk('q7_1_3');"><input class="form-check-input" type="radio" name="q7_1" value="3" id="q7_1_3"></TD>
					<TD onclick="javascript:td_clk('q7_1_4');"><input class="form-check-input" type="radio" name="q7_1" value="4" id="q7_1_4"></TD>
					<TD onclick="javascript:td_clk('q7_1_5');"><input class="form-check-input" type="radio" name="q7_1" value="5" id="q7_1_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q7_2"><SPAN CLASS="QUESTION_NO">7-2.</SPAN>조사시스템의 사용 방법이 쉽고 명확합니까?</TD>
					<TD onclick="javascript:td_clk('q7_2_1');"><input class="form-check-input" type="radio" name="q7_2" value="1" id="q7_2_1"></TD>
					<TD onclick="javascript:td_clk('q7_2_2');"><input class="form-check-input" type="radio" name="q7_2" value="2" id="q7_2_2"></TD>
					<TD onclick="javascript:td_clk('q7_2_3');"><input class="form-check-input" type="radio" name="q7_2" value="3" id="q7_2_3"></TD>
					<TD onclick="javascript:td_clk('q7_2_4');"><input class="form-check-input" type="radio" name="q7_2" value="4" id="q7_2_4"></TD>
					<TD onclick="javascript:td_clk('q7_2_5');"><input class="form-check-input" type="radio" name="q7_2" value="5" id="q7_2_5"></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q7_3"><SPAN CLASS="QUESTION_NO">7-3.</SPAN>매뉴얼이나 도움말 기능이 조사에 효과적입니까?</TD>
					<TD onclick="javascript:td_clk('q7_3_1');"><input class="form-check-input" type="radio" name="q7_3" value="1" id="q7_3_1"></TD>
					<TD onclick="javascript:td_clk('q7_3_2');"><input class="form-check-input" type="radio" name="q7_3" value="2" id="q7_3_2"></TD>
					<TD onclick="javascript:td_clk('q7_3_3');"><input class="form-check-input" type="radio" name="q7_3" value="3" id="q7_3_3"></TD>
					<TD onclick="javascript:td_clk('q7_3_4');"><input class="form-check-input" type="radio" name="q7_3" value="4" id="q7_3_4"></TD>
					<TD onclick="javascript:td_clk('q7_3_5');"><input class="form-check-input" type="radio" name="q7_3" value="5" id="q7_3_5"></TD>
				</TR>			
			</TABLE>
		</div>
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				...
				<TR>
					...
					<TD onclick="javascript:td_clk('q8_1_1');"><input class="form-check-input" type="radio" name="q8_1" value="1" id="q8_1_1"></TD>
					<TD onclick="javascript:td_clk('q8_1_2');"><input class="form-check-input" type="radio" name="q8_1" value="2" id="q8_1_2"></TD>
					<TD onclick="javascript:td_clk('q8_1_3');"><input class="form-check-input" type="radio" name="q8_1" value="3" id="q8_1_3"></TD>
					<TD onclick="javascript:td_clk('q8_1_4');"><input class="form-check-input" type="radio" name="q8_1" value="4" id="q8_1_4"></TD>
					<TD onclick="javascript:td_clk('q8_1_5');"><input class="form-check-input" type="radio" name="q8_1" value="5" id="q8_1_5"></TD>
				</TR>
				<TR>
    ...
    <div class="panel-body">
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						...
						<TD onclick="javascript:td_clk('q9_1_1');"><input class="form-check-input" type="radio" name="q9_1" value="1" id="q9_1_1"></TD>
						<TD onclick="javascript:td_clk('q9_1_2');"><input class="form-check-input" type="radio" name="q9_1" value="2" id="q9_1_2"></TD>
						<TD onclick="javascript:td_clk('q9_1_3');"><input class="form-check-input" type="radio" name="q9_1" value="3" id="q9_1_3"></TD>
						<TD onclick="javascript:td_clk('q9_1_4');"><input class="form-check-input" type="radio" name="q9_1" value="4" id="q9_1_4"></TD>
						<TD onclick="javascript:td_clk('q9_1_5');"><input class="form-check-input" type="radio" name="q9_1" value="5" id="q9_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q9_2_2"><SPAN CLASS="QUESTION_NO">9-2.</SPAN>분석장표를 주로 어떤 목적으로 사용하십니까?</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q9_2" id="q9_2_2" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q9_2_3"><SPAN CLASS="QUESTION_NO">9-3.</SPAN>분석장표에 개선이 필요한 경우, 자유롭게 기술해 주십시오.</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q9_3" id="q9_2_3" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
				</TABLE>
			</div>
		</div>
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						...
						<TD onclick="javascript:td_clk('q10_1_1');"><input class="form-check-input" type="radio" name="q10_1" value="1" id="q10_1_1"></TD>
						<TD onclick="javascript:td_clk('q10_1_2');"><input class="form-check-input" type="radio" name="q10_1" value="2" id="q10_1_2"></TD>
						<TD onclick="javascript:td_clk('q10_1_3');"><input class="form-check-input" type="radio" name="q10_1" value="3" id="q10_1_3"></TD>
						<TD onclick="javascript:td_clk('q10_1_4');"><input class="form-check-input" type="radio" name="q10_1" value="4" id="q10_1_4"></TD>
						<TD onclick="javascript:td_clk('q10_1_5');"><input class="form-check-input" type="radio" name="q10_1" value="5" id="q10_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q10_2_2"><SPAN CLASS="QUESTION_NO">10-2.</SPAN>시각화장표를 주로 어떤 목적으로 사용하십니까?</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q10_2" id="q10_2_2" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q10_2_3"><SPAN CLASS="QUESTION_NO">10-3.</SPAN>시각화장표에 개선이 필요한 경우, 자유롭게 기술해 주십시오.</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q10_3" id="q10_2_3" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
				</TABLE>
			</div>
		</div>
		...
		<div id="q10_t2" style="display:none;">
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					<TR>
						<TD class="td2"  id="label_q10_4" style="font-weight:bold;"><SPAN CLASS="QUESTION_NO">10-4.</SPAN>시각화장표 미사용 사유를 기술해 주십시오.</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q10_4" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
				</TABLE>
			 </div>
		</div>
			...
			<div class="table-responsive">
				<TABLE CLASS="table table-bordered table-hover">
					...
					<TR>
						...
						<TD onclick="javascript:td_clk('q11_1_1');"><input class="form-check-input" type="radio" name="q11_1" value="1" id="q11_1_1"></TD>
						<TD onclick="javascript:td_clk('q11_1_2');"><input class="form-check-input" type="radio" name="q11_1" value="2" id="q11_1_2"></TD>
						<TD onclick="javascript:td_clk('q11_1_3');"><input class="form-check-input" type="radio" name="q11_1" value="3" id="q11_1_3"></TD>
						<TD onclick="javascript:td_clk('q11_1_4');"><input class="form-check-input" type="radio" name="q11_1" value="4" id="q11_1_4"></TD>
						<TD onclick="javascript:td_clk('q11_1_5');"><input class="form-check-input" type="radio" name="q11_1" value="5" id="q11_1_5"></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q11_2"><SPAN CLASS="QUESTION_NO">11-2.</SPAN>청년진로를 주로 어떤 목적으로 사용하십니까?</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q11_2" id="q11_2_2" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
					<TR>
						<TD class="td2" id="label_q11_3"><SPAN CLASS="QUESTION_NO">11-3.</SPAN>청년진로에 개선이 필요한 경우, 자유롭게 기술해 주십시오.</TD>
						<TD COLSPAN="5"><TEXTAREA NAME="q11_3" id="q11_2_3" CLASS="INPUT_TXT"/></TEXTAREA></TD>
					</TR>
				</TABLE>
			</div>
		</div>
		...
		<DIV CLASS="DESC_BOX">
			<span style="font-weight:bold; font-size:16px;">※ 의견이 있으신 경우, 다음 예시를 참고하여 작성해주시기 바랍니다.</span><br>
			<div class="table-responsive">
			<table CLASS="table table-bordered">
				<tr class="active">
					<th width="33%">구분</th>
					<th width="33%">답변예시1</th>
					<th width="33%">답변예시2</th>
				</tr>
				<tr>
					<td>어떤 자료(서비스)가 필요하십니까?</td>
					<td>과거 개인별 최종취업구분 정보</td>
					<td>근무지역별 취업현황(시군구 단위)</td>
				</tr>
				<tr>
					<td>필요한 이유는 무엇입니까?</td>
					<td>분석, 외부기관 요청 대응 등</td>
					<td>분석, 내부 보고문서 작성 등</td>
				</tr>
			</table>
			</div>
 			<span style="font-weight:bold; font-size:16px;">※ 설문조사 외에도 자료(서비스) 내용이나 장표양식에 관하여 구체적인 의견을 주실 분은 swiss@kedi.re.kr 메일 발송 바람.</span><br>
		</DIV>
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				<TR>
					<TD class="td2" id="label_q12_1"><SPAN CLASS="QUESTION_NO">12-1.</SPAN>어떤 자료(서비스)가 필요하십니까?</TD>
					<TD COLSPAN="5"><TEXTAREA NAME="q12_1" id="q12_1_1" CLASS="INPUT_TXT"/></TEXTAREA></TD>
				</TR>
				<TR>
					<TD class="td2" id="label_q12_3"><SPAN CLASS="QUESTION_NO">12-2.</SPAN>필요한 이유는 무엇입니까?</TD>
					<TD COLSPAN="5"><TEXTAREA NAME="q12_3" id="q12_1_2" CLASS="INPUT_TXT"/></TEXTAREA></TD>
				</TR>				
			</TABLE>
		</div>
    </div>
...
<%
	String SURVEYCD = request.getParameter("SURVEY_CODE").replaceAll("<", "<").replaceAll(">", ">");
	String USRID = request.getParameter("USERID").replaceAll("<", "<").replaceAll(">", ">");
%>
	<input type="hidden" name="SURVEY_CODE" id="SURVEY_CODE" value="<%=SURVEYCD%>" />
	<input type="hidden" name="USERID" id="USERID" value="<%=USRID%>" />
	<input type="hidden" name="formStatus" id="formStatus" value="" />
	
	<div style="text-align:center; background:;"><button class="btn btn-lg btn-primary btn-block" type="button" id="btn_submit" style=" display:none;" onclick="javascript:go_Submit();">제출</button></div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-md modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modal_body" style="font-weight:bold;">
        ...
      </div>
...
<script>
	...
	$("#q1_1_1").prop('checked',true);
	$("#q1_2_2").prop('checked',true);
	
	$("#q2_1").prop('checked',true);
	$('#q2_t1').css('display','block');
	$("#q2_1_2").prop('checked',true);
	$("#q2_2_4").prop('checked',true);
	$("#q2_3").val('q2_3_text');
	
	$("#q3_1_1").prop('checked',true);
	$('#q3_1_t1').css('display','block');
	$("#q3_1_1_1").prop('checked',true);
	$("#q3_1_2_4").prop('checked',true);
	$("#q3_1_3_5").prop('checked',true);
	$("#q3_1_4").val('q3_1_4_text');
		
	$("#q3_2_1").prop('checked',true);
	
	$("#q4_1").prop('checked',true);
	$('#q4_t1').css('display','block');
	$("#q4_1_1").prop('checked',true);
	$("#q4_2_2").prop('checked',true);
	$("#q4_3_3").prop('checked',true);
	$("#q4_4_4").prop('checked',true);
	$("#q4_5").val('q4_5_text');	
	
	$("#q5_1_1").prop('checked',true);
	$("#q5_2_3").prop('checked',true);
	$("#q5_3_4").prop('checked',true);
		
	$("#q6_1_1").prop('checked',true);
	$("#q6_2_4").prop('checked',true);
	$("#q6_3_5").prop('checked',true);
	
	$("#q7_1_1").prop('checked',true);
	$("#q7_2_3").prop('checked',true);
	$("#q7_3_5").prop('checked',true);		
	
	$("#q8_1_1").prop('checked',true);
	$("#q8_2").val('q8_2_text');
	
	$("#q9_1").prop('checked',true);
	$('#q9_t1').css('display','block');
	$("#q9_1_5").prop('checked',true);
	$("#q9_2_2").val('q9_2_2_text');
	$("#q9_2_3").val('q9_2_3_text');		
	
	$("#q10_1").prop('checked',true);
	$('#q10_t1').css('display','block');
	$("#q10_1_3").prop('checked',true);
	$("#q10_2_2").val('q10_2_2_text');
	$("#q10_2_3").val('q10_2_3_text');		
	
	$("#q11_1").prop('checked',true);
	$('#q11_t1').css('display','block');
	$("#q11_1_2").prop('checked',true);
	$("#q11_2_2").val('q11_2_2_text');
	$("#q11_2_3").val('q11_2_3_text');		
