  ...
  <div class="panel panel-success">
    ...
    <div class="panel-body">
		...
		<div class="table-responsive">
			<TABLE CLASS="table table-bordered table-hover">
				<TR>
					<TD class="td2" id="label_q12" style="font-weight:bold;"><SPAN CLASS="QUESTION_NO">12.</SPAN>지역통계로 추가했으면 하는 장표가 있다면 서술해주세요.</TD>
...
%>
	<input type="text" name="SURVEY_CODE" id="SURVEY_CODE" value="<%=SURVEYCD%>" />
	<input type="text" name="USERID" id="USERID" value="<%=USRID%>" />
