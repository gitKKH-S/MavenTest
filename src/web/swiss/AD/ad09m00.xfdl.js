(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"43\"/><Column size=\"78\"/><Column size=\"228\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"146\"/><Column size=\"103\"/><Column size=\"132\"/><Column size=\"75\"/><Column size=\"160\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"25\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" rowspan=\"2\" text=\"조사기준\"/><Cell col=\"2\" rowspan=\"2\" text=\"학교명\"/><Cell col=\"3\" rowspan=\"2\" text=\"본분교\"/><Cell col=\"4\" colspan=\"3\" text=\"담당자\"/><Cell col=\"7\" rowspan=\"2\" text=\"제출일시\"/><Cell col=\"8\" rowspan=\"2\" text=\"제출횟수\"/><Cell col=\"9\" rowspan=\"2\" text=\"진행상태\"/><Cell row=\"1\" col=\"4\" text=\"이름\"/><Cell row=\"1\" col=\"5\" text=\"아이디\"/><Cell row=\"1\" col=\"6\" text=\"구분\"/></Band><Band id=\"body\"><Cell edittype=\"checkbox\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"bind:SURVSEQ\"/><Cell col=\"2\" text=\"bind:SCHNM\" tooltiptext=\"bind:SCHNM\"/><Cell col=\"3\" text=\"bind:ORGNM\"/><Cell col=\"4\" text=\"bind:USERNM\" tooltiptext=\"bind:USERNM\"/><Cell col=\"5\" text=\"bind:USERID\" tooltiptext=\"bind:USERID\"/><Cell col=\"6\" text=\"bind:USERTYPE\" tooltiptext=\"bind:USERTYPE\"/><Cell col=\"7\" text=\"bind:SENDDATE\" displaytype=\"normal\" calendardateformat=\"yyyy-MM-dd hh:mm\" calendareditformat=\"yyyy-MM-dd hh:mm\" tooltiptext=\"bind:SENDDATE\"/><Cell col=\"8\" text=\"bind:SENDCNT\"/><Cell col=\"9\" text=\"bind:SURVPROSTATUSNM\" tooltiptext=\"bind:SURVPROSTATUSNM\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad09m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad09m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad09m00.xfdl", function() {
        ...
        */
        ...
        this.fnCallback = function(serviceId, errCD, errMSG){
        	if(serviceId == "initFpInfo"){
        		...
        		this.yearChanged();
        		this.searchFpInfoCnt();
        	} else if(serviceId == "searchFpInfoCnt"){
        		this.totalRowCnt = this.ds_cnt.getColumn(0, "CNT");
        		this.paggingInit();
        		this.searchFpInfoList(this.Div.form.pagingWrap.form.div_pagging.form.fv_pageIdx+1);
        	} else if(serviceId == "searchFpInfoList"){
        ...
        this.searchFpInfoCnt = function(){
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("searchFpInfoCnt",
        						"swiss/ad/progress/searchFpInfoCnt.do",
        						"dsSearch=ds_search",
        						"ds_cnt=dsResult",
        						"",
        						"fnCallback",
        ...
        // 목록
        this.searchFpInfoList = function(sPage){
        	var SURVYEAR		= this.Div.form.div_searchArea.form.in_cb_year.value;
        	var SCHKINDCD		= this.Div.form.div_searchArea.form.in_cb_schkind.value;
        	var SCHNM 			= this.Div.form.div_searchArea.form.in_edit_school.value;
        	var SURVPROSTATUSCD	= this.Div.form.div_searchArea.form.in_cb_prostatus.value;
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("searchFpInfoList",
        						"swiss/ad/progress/searchFpInfoList.do",
        						"dsSearch=ds_search",
        						"ds_list=dsResult",
        						"",
        						"fnCallback",
        ...
        {
        	this.utlf_excelDownload("신편입생학생정보제출현황", this.Div.form.gd_list, this.Export00_onsuccess);
        };
        ...
        this.loadIncludeScript("ad09m00.xfdl");
