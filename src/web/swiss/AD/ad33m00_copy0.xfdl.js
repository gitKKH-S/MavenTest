(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"100\"/><Column size=\"179\"/><Column size=\"129\"/><Column size=\"120\"/><Column size=\"212\"/><Column size=\"48\"/><Column size=\"48\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"일시\"/><Cell col=\"1\" text=\"대상\"/><Cell col=\"2\" text=\"유형\"/><Cell col=\"3\" text=\"PC\"/><Cell col=\"4\" text=\"로그인ID\"/><Cell col=\"5\" text=\"메모\"/><Cell col=\"6\"/><Cell col=\"7\"/></Band><Band id=\"body\"><Cell text=\"bind:CHGDTHM\"/><Cell col=\"1\" text=\"bind:CHGTABLE\"/><Cell col=\"2\" text=\"bind:CHGTYPE\"/><Cell col=\"3\" text=\"bind:CHGPCNAME\"/><Cell col=\"4\" text=\"bind:CHGPCID\"/><Cell col=\"5\" displaytype=\"editcontrol\" edittype=\"text\" maskedittype=\"string\" editmaxlength=\"1000\" editautoselect=\"true\" editinputtype=\"normal\" text=\"bind:CHGMEMO\"/><Cell col=\"6\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"수정\"/><Cell col=\"7\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"내려받기\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad33m00_copy0.xfdl","CM::common.xjs");
        this.addIncludeScript("ad33m00_copy0.xfdl","CM::utl_script.xjs");
        this.registerScript("ad33m00_copy0.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("ad33m00_copy0.xfdl");
