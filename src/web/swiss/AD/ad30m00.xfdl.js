(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","30","79","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("3");
            obj.set_text("검색대상");
            ...
            obj = new Combo("in_target","Static00_00:103","79","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("1");
            obj.set_accessibilitylabel("검색대상");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_visible("true");
            var Div_form_sub_search_form_in_target_innerdataset = new nexacro.NormalDataset("Div_form_sub_search_form_in_target_innerdataset", obj);
            Div_form_sub_search_form_in_target_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">BASIC</Col><Col id=\"datacolumn\">개인정보</Col></Row><Row><Col id=\"codecolumn\">ALL</Col><Col id=\"datacolumn\">전체</Col></Row></Rows>");
            obj.set_innerdataset(Div_form_sub_search_form_in_target_innerdataset);
            obj.set_text("검색대상");
            obj.set_value("BASIC");
            obj.set_index("0");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00","290","79","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("5");
            obj.set_text("학교");
            obj.set_visible("true");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Edit("in_schnm","333","79","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("6");
            obj.set_enable("true");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","520","79","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("9");
            obj.set_text("메뉴명");
            obj.set_visible("true");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Edit("in_menunm","573","79","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("10");
            obj.set_enable("true");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Static("Static00_00_01","760","79","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("11");
            obj.set_text("액션");
            obj.set_visible("true");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Edit("in_action","803","79","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("12");
            obj.set_enable("true");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Grid("gd_main","30","btn_filesave:17",null,"532","30",null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"200\"/><Column size=\"90\"/><Column size=\"200\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"300\"/><Column size=\"90\"/><Column size=\"500\"/><Column size=\"150\"/><Column size=\"160\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"로그인ID\"/><Cell col=\"2\" text=\"사용자명\"/><Cell col=\"3\" text=\"IP\"/><Cell col=\"4\" text=\"사용자구분\"/><Cell col=\"5\" text=\"학교코드\"/><Cell col=\"6\" text=\"본분교코드\"/><Cell col=\"7\" text=\"학교명\"/><Cell col=\"8\" text=\"조사기준일\"/><Cell col=\"9\" text=\"조사구분\"/><Cell col=\"10\" text=\"메뉴\"/><Cell col=\"11\" text=\"액션\"/><Cell col=\"12\" text=\"파라미터\"/><Cell col=\"13\" text=\"사유\"/><Cell col=\"14\" text=\"일시\"/></Band><Band id=\"body\"><Cell text=\"bind:SEQ\"/><Cell col=\"1\" text=\"bind:USERID\"/><Cell col=\"2\" text=\"bind:USERNM\"/><Cell col=\"3\" text=\"bind:LOGIP\"/><Cell col=\"4\" text=\"bind:USERGRPTYPE\"/><Cell col=\"5\" text=\"bind:SCHCD\"/><Cell col=\"6\" text=\"bind:ORGCD\"/><Cell col=\"7\" text=\"bind:SCHNM\"/><Cell col=\"8\" text=\"bind:SURVSEQ\"/><Cell col=\"9\" text=\"bind:SURVKINDCD\"/><Cell col=\"10\" text=\"bind:ALLMENUNM\"/><Cell col=\"11\" text=\"bind:ACTION\"/><Cell col=\"12\" text=\"bind:STRPARAM\"/><Cell col=\"13\" text=\"bind:STRCOMMENT\"/><Cell col=\"14\" text=\"bind:MODDTHM\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad30m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad30m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad30m00.xfdl", function() {
        ...
        */
        ...
        this.selectWebLogList = function(){
        	...
        	*/
        	...
        	this.gfnTransaction("selectWebLogList",
        						"/swiss/ad/system/selectWebLogListNew.do",
        						"dsSearch=dsSearch",
        ...
        {
        	this.utlf_excelDownload("웹로그", this.Div.form.gd_main, this.Export00_onsuccess);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.sub_search.form.in_menunm.addEventHandler("onkeyup",this.searchEnter,this);
            this.Div.form.sub_search.form.in_action.addEventHandler("onkeyup",this.searchEnter,this);
        ...
        this.loadIncludeScript("ad30m00.xfdl");
