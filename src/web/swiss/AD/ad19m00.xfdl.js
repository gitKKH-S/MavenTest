(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_loginlist", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("in_calr_start","104","73","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("7");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Calendar("in_calr_end","label_00_00_00:5","73","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("8");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Static("Static00_00","in_calr_end:51","30","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("3");
            obj.set_text("조사종류");
            obj.set_visible("true");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_01_01_00_00","in_calr_end:51","73","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("9");
            obj.set_text("구분");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Grid("gd_main","30","btn_filesave:20","1200","532",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_autofittype("col");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_loginlist");
            obj.set_cellmovingtype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"300\"/><Column size=\"179\"/><Column size=\"224\"/><Column size=\"187\"/><Column size=\"211\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"사용자ID\"/><Cell col=\"2\" text=\"사용자명\"/><Cell col=\"3\" text=\"사용자그룹\"/><Cell col=\"4\" text=\"접속IP\"/><Cell col=\"5\" text=\"접속일시\"/></Band><Band id=\"body\"><Cell text=\"bind:RNUM\"/><Cell col=\"1\" text=\"bind:USERID\"/><Cell col=\"2\" text=\"bind:USERNM\"/><Cell col=\"3\" text=\"bind:USERGRPTYPESTR\"/><Cell col=\"4\" text=\"bind:LOGIP\"/><Cell col=\"5\" text=\"bind:WORKDTHM\" displaytype=\"normal\" edittype=\"none\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);

            obj = new Div("pagingWrap","30","848","1200","60",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("7");
            obj.set_text("");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad19m00.xfdl","CM::common.xjs");
        this.registerScript("ad19m00.xfdl", function() {
        ...
        this.fv_MENUNM = "관리자>시스템관리>로그인조회";
        ...
        this.ad19m00_onload = function(obj,e)
        {
        ...
        this.loginLogList = function(){
        	...
        	if( parseInt(interval/day) > 7 ){
        		this.alert("시작일과 종료일 차이는 7일 이내로 선택 해 주세요.");
        		return;
        	}
        	...
        	this.gfnTransaction("loginLogList",
        						"/swiss/ad/system/loginLogList.do",
        						"dsSearch=dsSearch",
        						"ds_loginlist=dsResult",
        						"",
        						"fnCallback",
        						false);
        };
        ...
        {
            this.addEventHandler("onload",this.ad19m00_onload,this);
            this.Div.form.sub_search.form.btn_search.addEventHandler("onclick",this.loginLogList,this);
            this.Div.form.sub_search.form.in_calr_end.addEventHandler("onchanged",this.Div_sub_search_in_calr_end_onchanged,this);
        ...
        this.loadIncludeScript("ad19m00.xfdl");
