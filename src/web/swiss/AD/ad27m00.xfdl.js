(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"SURVPROSTATUSCD\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div","0","-30","1260","1130",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00","0","0","30","1130",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("1");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static00_00","1230","0","30","1130",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new Div("div_mntrArea","30","sub_title_wrap:10","1200","80",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static00","25","5","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("0");
            obj.set_text("미제출  :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_01_01_00","335","40","90","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("1");
            obj.set_text("KEDI승인 :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_00","335","5","90","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("2");
            obj.set_text("졸업자수수정 :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_01_01_00_00","980","40","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("3");
            obj.set_text("합계 :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_01","25","40","80","33",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("4");
            obj.set_text("졸업생제출  :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","655","5","90","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("5");
            obj.set_text("졸업자수제출 :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("Static00_00_01","980","5","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("6");
            obj.set_text("졸업생등록 :");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_unSubmit","Static00:10","5","85","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("7");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_gradSubmit","Static00_01:10","40","85","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("8");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_gradCntUpdate","Static00_00:10","5","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("9");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_gradCntSubmit","Static00_00_00:10","5","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("10");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_gradRegist","Static00_00_01:10","5","85","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("11");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_kediApprove","Static00_01_01_00:10","40","80","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("12");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Static("label_total","Static00_01_01_00_00:10","40","85","30",null,null,null,null,null,null,this.Div.form.div_mntrArea.form);
            obj.set_taborder("13");
            obj.set_text("0");
            this.Div.form.div_mntrArea.addChild(obj.name, obj);

            obj = new Div("div_searchArea","30","div_mntrArea:20","1200","155",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("4");
            obj.set_border("1px solid #a5a5a5");
            obj.set_background("#ffffff");
            ...
            obj.set_taborder("1");
            obj.set_text("졸업생정보 반려");
            obj.set_cssclass("btn_sty02");
            this.Div.form.btnArea.addChild(obj.name, obj);

            obj = new Button("btn_approval",null,"21","120","30","btn_return:10",null,null,null,null,null,this.Div.form.btnArea.form);
            obj.set_taborder("2");
            obj.set_text("졸업생정보 승인");
            obj.set_cssclass("btn_sty02");
            this.Div.form.btnArea.addChild(obj.name, obj);

            obj = new Button("btn_returnGradCnt",null,"21","120","30","2",null,null,null,null,null,this.Div.form.btnArea.form);
            obj.set_taborder("3");
            obj.set_text("졸업자수 반려");
            obj.set_cssclass("btn_sty02");
            this.Div.form.btnArea.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"75\"/><Column size=\"230\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"145\"/><Column size=\"145\"/><Column size=\"130\"/><Column size=\"235\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"25\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" rowspan=\"2\" text=\"조사기준\"/><Cell col=\"2\" rowspan=\"2\" text=\"학교명\"/><Cell col=\"3\" rowspan=\"2\" text=\"본분교\"/><Cell col=\"4\" colspan=\"3\" text=\"담당자\"/><Cell col=\"7\" rowspan=\"2\" text=\"제출일시\"/><Cell col=\"8\" rowspan=\"2\" text=\"진행상태\"/><Cell row=\"1\" col=\"4\" text=\"이름\"/><Cell row=\"1\" col=\"5\" text=\"이메일\"/><Cell row=\"1\" col=\"6\" text=\"전화번호\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:SURVPROSTATUSCD &gt; 6 ?'checkboxcontrol':SURVPROSTATUSCD == '2'?'checkboxcontrol':SURVPROSTATUSCD == '4'?'checkboxcontrol':SURVPROSTATUSCD == '6'?'checkboxcontrol':'none'\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:SURVSEQ\" tooltiptext=\"bind:SURVSEQ\"/><Cell col=\"2\" text=\"bind:SCHNM\" tooltiptext=\"bind:SCHNM\"/><Cell col=\"3\" text=\"bind:ORGNM\" tooltiptext=\"bind:ORGNM\"/><Cell col=\"4\" text=\"bind:USERNM\" tooltiptext=\"bind:USERNM\"/><Cell col=\"5\" text=\"bind:USERID\" tooltiptext=\"bind:USERID\"/><Cell col=\"6\" text=\"bind:TELNO\" tooltiptext=\"bind:TELNO\"/><Cell col=\"7\" text=\"bind:SENDDATE\" displaytype=\"normal\" calendardateformat=\"yyyy-MM-dd hh:mm\" calendareditformat=\"yyyy-MM-dd hh:mm\" tooltiptext=\"bind:SENDDATE\"/><Cell col=\"8\" text=\"bind:SURVPROSTATUSNM\" tooltiptext=\"bind:SURVPROSTATUSNM\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
            ...
            obj = new Grid("gd_list_excel","375","500","830","377",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("9");
            obj.set_binddataset("ds_excel");
            obj.set_autofittype("col");
            obj.set_cssclass("grid_sty02");
            obj.set_visible("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"75\"/><Column size=\"230\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"145\"/><Column size=\"145\"/><Column size=\"130\"/><Column size=\"235\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"25\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" rowspan=\"2\" text=\"조사기준\"/><Cell col=\"2\" rowspan=\"2\" text=\"학교명\"/><Cell col=\"3\" rowspan=\"2\" text=\"본분교\"/><Cell col=\"4\" colspan=\"3\" text=\"담당자\"/><Cell col=\"7\" rowspan=\"2\" text=\"제출일시\"/><Cell col=\"8\" rowspan=\"2\" text=\"진행상태\"/><Cell row=\"1\" col=\"4\" text=\"이름\"/><Cell row=\"1\" col=\"5\" text=\"이메일\"/><Cell row=\"1\" col=\"6\" text=\"전화번호\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:SURVPROSTATUSCD &gt; 6 ?'checkboxcontrol':SURVPROSTATUSCD == '2'?'checkboxcontrol':SURVPROSTATUSCD == '4'?'checkboxcontrol':SURVPROSTATUSCD == '6'?'checkboxcontrol':'none'\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:SURVSEQ\" tooltiptext=\"bind:SURVSEQ\"/><Cell col=\"2\" text=\"bind:SCHNM\" tooltiptext=\"bind:SCHNM\"/><Cell col=\"3\" text=\"bind:ORGNM\" tooltiptext=\"bind:ORGNM\"/><Cell col=\"4\" text=\"bind:USERNM\" tooltiptext=\"bind:USERNM\"/><Cell col=\"5\" text=\"bind:USERID\" tooltiptext=\"bind:USERID\"/><Cell col=\"6\" text=\"bind:TELNO\"/><Cell col=\"7\" text=\"bind:SENDDATE\" displaytype=\"normal\" calendardateformat=\"yyyy-MM-dd hh:mm\" calendareditformat=\"yyyy-MM-dd hh:mm\" tooltiptext=\"bind:SENDDATE\"/><Cell col=\"8\" text=\"bind:SURVPROSTATUSNM\" tooltiptext=\"bind:SURVPROSTATUSNM\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad27m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad27m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad27m00.xfdl", function() {
        this.executeIncludeScript("CM::common.xjs"); /*include "CM::common.xjs"*/;
        this.executeIncludeScript("CM::utl_script.xjs"); /*include "CM::utl_script.xjs"*/;

        this.fv_SURVSEQ = "";
        this.fv_MENUNM = "관리자>조사진행>졸업생정보";
        ...
        this.ad27m00_oninit = function(obj,e)
        {
        	this.initGpInfo();
        	this.getGpSurvProStatusNmCnt();
        };

        this.fnCallback = function(serviceId, errCD, errMSG){
        	if(errCD < 0){
        		//trace(errCD);
        		this.setAccessLog(this.fv_SURVSEQ, "GP", this.fv_MENUNM, serviceId + " : Fail", "");  //접속기록(실패시)
        		alert(errMSG);
        	}else{
        		if(serviceId == "initGpInfo"){
        			this.Div.form.div_searchArea.form.in_cb_year.set_index(0);
        			this.yearChanged();
        			this.searchGpInfoResultCnt();
        		} else if(serviceId == "searchGpInfoResultCnt"){
        			this.totalRowCnt = this.ds_cnt.getColumn(0, "CNT");
        			this.paggingInit();
        			//this.searchGpInfoResultList(this.Div.form.pagingWrap.form.div_pagging.form.fv_pageIdx+1);
        		} else if(serviceId == "searchGpInfoResultList"){

        		} else if(serviceId =="updateMultiApproval"){
        			this.getGpSurvProStatusNmCnt();
        			...
        			this.searchGpInfoResultCnt();
        			this.getGpSurvProStatusNmCnt();
        		} else if(serviceId == "getGpSurvProStatusNmCnt"){
        			...
        			for(var i=0; i<this.ds_survProStatusNmCnt.rowcount; i++){
        				var SURVPROSTATUSCD = this.ds_survProStatusNmCnt.getColumn(i, "SURVPROSTATUSCD");
        				var cnt = this.ds_survProStatusNmCnt.getColumn(i, "CNT");
        				if( SURVPROSTATUSCD == "1" || SURVPROSTATUSCD == "5" || SURVPROSTATUSCD == "13"){
        					unSubmit = unSubmit + cnt;
        				} else if( SURVPROSTATUSCD == "2" || SURVPROSTATUSCD == "3" ) {
        					gradCntUpdate = gradCntUpdate + cnt;
        				} else if( SURVPROSTATUSCD == "4" ) {
        					gradCntSubmit = gradCntSubmit + cnt;
        				} else if(SURVPROSTATUSCD == "6" || SURVPROSTATUSCD == "7" || SURVPROSTATUSCD == "8" || SURVPROSTATUSCD == "9" || SURVPROSTATUSCD == "10") {
        					gradRegist = gradRegist + cnt;
        				} else if(SURVPROSTATUSCD == "11") {
        					gradSubmit = gradSubmit + cnt;
        				} else if(SURVPROSTATUSCD == "12") {
        					kediApprove = kediApprove + cnt;
        				}
        			}

        			total = unSubmit + gradCntUpdate + gradCntSubmit + gradRegist + gradSubmit + kediApprove;

        			this.Div.form.div_mntrArea.form.label_unSubmit.set_text(unSubmit);
        			this.Div.form.div_mntrArea.form.label_gradCntUpdate.set_text(gradCntUpdate);
        			this.Div.form.div_mntrArea.form.label_gradCntSubmit.set_text(gradCntSubmit);
        			this.Div.form.div_mntrArea.form.label_gradRegist.set_text(gradRegist);
        			this.Div.form.div_mntrArea.form.label_gradSubmit.set_text(gradSubmit);
        			this.Div.form.div_mntrArea.form.label_kediApprove.set_text(kediApprove);
        			this.Div.form.div_mntrArea.form.label_total.set_text(total);
        		} else if (serviceId == "gpInfoResultListExcel"){
        			if(this.ds_excel.rowcount==0){
        				alert("파일저장할 내역이 없습니다");
        				return;
        			}

        			this.utlf_excelDownload("졸업생학생정보제출현황", this.Div.form.gd_list_excel, this.Export00_onsuccess);
        		}
        	}
        }
        ...
        this.Div_btnArea_btn_returnGradCnt_onclick = function(obj,e)
        {
        	...
        	for(var i=0; i<objDS.rowcount; i++){
        		...
        		if(chk == true){
        			...
        			if(this.fv_updateApprovalStatus == 1 && tmpStatus < 7){
        				this.alert("[졸업자수반려]버튼을 사용해주세요");
        				this.fv_updateApprovalStatus = 0;
        				return true;
        			}

        			if(this.fv_updateApprovalStatus == 2 && tmpStatus >= 7){
        				this.alert("[졸업생정보반려]버튼을 사용해주세요");
        				this.fv_updateApprovalStatus = 0;
        				return true;
        			}
        		}
        ...
        this.Div_gd_list_oncellclick = function(obj,e)
        {
        	...
        	if(nPos != "0"){
        		if(nPos == "8"){	//수정요청 히스토리
        			...
        			var objChildFrame = new ChildFrame();
        			objChildFrame.init("pop_ad06p00_info"
        							  , 0
        							  , 0
        							  , 1150
        							  , 700
        			...
        			var objParam = {
        				...
        				, SURVPROSTATUSCD : this.ds_list.getColumn(nRow,"SURVPROSTATUSCD")
        			};
        			objChildFrame.showModal(this.getOwnerFrame()
        								  , objParam
        								  , this
        ...
        this.fn_popupCallback = function(strPopupID, strReturn){
        	if(strPopupID == "pop_ad06p00_info"){
        		if("update" == strReturn){
        			this.searchGpInfoResultCnt();
        			this.getGpSurvProStatusNmCnt();
        		}
        ...
        this.searchGpInfoResultCnt = function(){
        	var SURVYEAR		= this.Div.form.div_searchArea.form.in_cb_year.value;
        	...
        	this.gfnTransaction("searchGpInfoResultCnt",
        						"swiss/ad/progress/searchGpInfoResultCnt.do",
        						"dsSearch=ds_search",
        						"ds_cnt=dsResult",
        						"",
        						"fnCallback",
        ...
        // 목록
        this.searchGpInfoResultList = function(sPage){
        	var SURVYEAR		= this.Div.form.div_searchArea.form.in_cb_year.value;
        	var SCHKINDCD		= this.Div.form.div_searchArea.form.in_cb_schkind.value;
        	var SCHNM 			= this.Div.form.div_searchArea.form.in_edit_school.value;
        	var SURVPROSTATUSCD	= this.Div.form.div_searchArea.form.in_cb_prostatus.value;
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.setAccessLog(this.fv_SURVSEQ, "GP", this.fv_MENUNM, "검색", strParam);  //접속기록
        	this.gfnTransaction("searchGpInfoResultList",
        						"swiss/ad/progress/searchGpInfoResultList.do",
        						"dsSearch=ds_search",
        						"ds_list=dsResult",
        						"",
        						"fnCallback",
        ...
        this.updateMultiApproval = function(proc, rceptcn){
        	...
        	this.setAccessLog(this.fv_SURVSEQ, "GP", this.fv_MENUNM, proc == "OK" ? "졸업생정보 승인" : "졸업생정보 반려", "");  //접속기록
        ...
        this.Div_btnArea_btn_fileDn_onclick = function(obj,e)
        {
        	...
        	this.setAccessLog(this.fv_SURVSEQ, "GP", this.fv_MENUNM, "파일저장", "");  //접속기록
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("gpInfoResultListExcel",
        						"swiss/ad/progress/searchGpInfoResultList.do",
        						"dsSearch=ds_search",
        						"ds_excel=dsResult",
        						"",
        ...
        this.setPageAfter = function (nPage){
        	this.searchGpInfoResultList(nPage);
        }
        ...
        this.updateApproval = function(rceptcn){
        	...
        	for(var i=0; i<objDS.rowcount; i++){
        		...
        		if(chk == true){
        			...
        			this.setAccessLog(this.fv_SURVSEQ, "GP", this.fv_MENUNM, "졸업자수 반려", strParam);  //접속기록
        ...
        // 진행상황
        this.getGpSurvProStatusNmCnt = function(){
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("getGpSurvProStatusNmCnt",
        ...
        {
            this.addEventHandler("oninit",this.ad27m00_oninit,this);
            ...
            this.Div.form.div_searchArea.form.in_cb_prostatus.addEventHandler("onitemchanged",this.Div_div_searchArea_in_cb_prostatus_onitemchanged,this);
            ...
            this.Div.form.btnArea.form.btn_returnGradCnt.addEventHandler("onclick",this.Div_btnArea_btn_returnGradCnt_onclick,this);
        ...
        this.loadIncludeScript("ad27m00.xfdl");
