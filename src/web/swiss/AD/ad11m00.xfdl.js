(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1260,980);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"SURVSEQ\" type=\"STRING\" size=\"32\"/><Column id=\"SCHNM\" type=\"STRING\" size=\"32\"/><Column id=\"SUCCNT\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"SCHKINDCD\" type=\"STRING\" size=\"32\"/><Column id=\"SCHKINDNM\" type=\"STRING\" size=\"32\"/><Column id=\"SURVPROSTATUSNM\" type=\"STRING\" size=\"32\"/><Column id=\"RNUM\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"SURVPROSTATUSCD\" type=\"STRING\" size=\"32\"/><Column id=\"TOTALSUCCNT\" type=\"STRING\" size=\"32\"/><Column id=\"TOTALCNT\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"ORGCD\" type=\"STRING\" size=\"32\"/><Column id=\"ORGNM\" type=\"STRING\" size=\"32\"/><Column id=\"SURVKINDCD\" type=\"STRING\" size=\"32\"/><Column id=\"_chk\" type=\"string\" size=\"256\"/><Column id=\"SCHCD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div","0","0","1260","970",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00_00","30","10","64","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("3");
            obj.set_text("취업구분");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_01_00_00_00_00_00","30","60","65","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("7");
            obj.set_text("제출여부");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Combo("in_cb_ady","116","60","240","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var Div_form_sub_search_form_in_cb_ady_innerdataset = new nexacro.NormalDataset("Div_form_sub_search_form_in_cb_ady_innerdataset", obj);
            Div_form_sub_search_form_in_cb_ady_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">예</Col></Row></Rows>");
            obj.set_innerdataset(Div_form_sub_search_form_in_cb_ady_innerdataset);
            obj.set_text("예");
            obj.set_value("1");
            obj.set_index("0");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Static("Static00_01_00_00_00_00_00_00","440","60","65","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("9");
            obj.set_text("제출여부");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Combo("in_chkcnt","526","60","240","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("10");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var Div_form_sub_search_form_in_chkcnt_innerdataset = new nexacro.NormalDataset("Div_form_sub_search_form_in_chkcnt_innerdataset", obj);
            Div_form_sub_search_form_in_chkcnt_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">있음</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">없음</Col></Row></Rows>");
            obj.set_innerdataset(Div_form_sub_search_form_in_chkcnt_innerdataset);
            obj.set_text("예");
            obj.set_value("1");
            obj.set_index("0");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Button("btn_return","1077","260","150","30",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_text("소명자료요청");
            ...
            obj = new Grid("gd_main","30","sub_search:60","1200","560",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"42\"/><Column size=\"160\"/><Column size=\"250\"/><Column size=\"120\"/><Column size=\"130\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"학제명\"/><Cell col=\"3\" text=\"학교명\"/><Cell col=\"4\" text=\"본분교명\"/><Cell col=\"5\" text=\"진행상태\"/><Cell col=\"6\" text=\"전체\"/><Cell col=\"7\" text=\"적합\"/><Cell col=\"8\" text=\"부적합\"/><Cell col=\"9\" text=\"확인필요\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:(SURVPROSTATUSCD=='12')?'checkboxcontrol':'normal'\" edittype=\"expr:(SURVPROSTATUSCD=='12')?'checkbox':'none'\" checkboxtruevalue=\"1\" text=\"bind:_chk\"/><Cell col=\"1\" text=\"bind:RNUM\"/><Cell col=\"2\" text=\"bind:SCHKINDNM\"/><Cell col=\"3\" text=\"bind:SCHNM\"/><Cell col=\"4\" text=\"bind:ORGNM\"/><Cell col=\"5\" text=\"bind:SURVPROSTATUSNM\"/><Cell col=\"6\" displaytype=\"normal\" edittype=\"none\" text=\"bind:TOTALCNT\"/><Cell col=\"7\" text=\"bind:TOTALSUCCNT\"/><Cell col=\"8\" text=\"bind:TOTALIMPRCNT\"/><Cell col=\"9\" text=\"bind:TOTALCONCNT\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\" colspan=\"5\" text=\"합계\"/><Cell col=\"6\" text=\"expr:dataset.getSum(&quot;TOTALCNT&quot;)\"/><Cell col=\"7\" text=\"expr:dataset.getSum(&quot;TOTALSUCCNT&quot;)\"/><Cell col=\"8\" text=\"expr:dataset.getSum(&quot;TOTALIMPRCNT&quot;)\"/><Cell col=\"9\" text=\"expr:dataset.getSum(&quot;TOTALCONCNT&quot;)\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);

            obj = new Div("pagingWrap","30","gd_main:10","1200","60",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("7");
            obj.set_text("");
            obj.set_visible("false");
            this.Div.addChild(obj.name, obj);
            ...
            obj = new Grid("gd_excel","324","gd_main:-260","904","260",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("10");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"140\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"150\"/><Column size=\"103\"/><Column size=\"94\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"155\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"190\"/><Column size=\"155\"/><Column size=\"147\"/><Column size=\"106\"/><Column size=\"158\"/><Column size=\"146\"/><Column size=\"153\"/><Column size=\"128\"/><Column size=\"153\"/><Column size=\"157\"/><Column size=\"205\"/><Column size=\"106\"/><Column size=\"118\"/><Column size=\"252\"/><Column size=\"129\"/><Column size=\"178\"/></Columns><Rows><Row size=\"42\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"학교코드\"/><Cell col=\"2\" text=\"학교명\"/><Cell col=\"3\" text=\"본분교코드\"/><Cell col=\"4\" text=\"본분교명\"/><Cell col=\"5\" text=\"학과명\"/><Cell col=\"6\" text=\"주야구분\"/><Cell col=\"7\" text=\"취업구분\"/><Cell col=\"8\" text=\"학번\"/><Cell col=\"9\" text=\"성명\"/><Cell col=\"10\" text=\"개인식별키\"/><Cell col=\"11\" text=\"적합여부명\"/><Cell col=\"12\" text=\"적합여부코드\" background=\"linear-gradient(to top,#eff0f0,#f9fafa) #fbfb1c\"/><Cell col=\"13\" text=\"반려사유\" background=\"linear-gradient(to top,#eff0f0,#f9fafa) #fbfb1c\"/><Cell col=\"14\" text=\"외국인유학생여부\"/><Cell col=\"15\" text=\"진학학교명\"/><Cell col=\"16\" text=\"진학학교본분교명\"/><Cell col=\"17\" text=\"국가명\"/><Cell col=\"18\" text=\"해외진학학교명\"/><Cell col=\"19\" text=\"해외취업회사명\"/><Cell col=\"20\" text=\"해외비자여부\"/><Cell col=\"21\" text=\"해외비자유형\"/><Cell col=\"22\" text=\"해외근무형태\"/><Cell col=\"23\" text=\"교내근무형태\"/><Cell col=\"24\" text=\"시작일/출판일/등록일\"/><Cell col=\"25\" text=\"종료일\"/><Cell col=\"26\" text=\"근무시간\"/><Cell col=\"27\" text=\"공연명/전시회명/도서명/작품명\"/><Cell col=\"28\" text=\"장소/출판사\"/><Cell col=\"29\" text=\"역할/작품명(개인)\"/><Cell col=\"30\" text=\"취업구분_수정\"/><Cell col=\"31\" text=\"동대학(원)진학여부_수정\"/><Cell col=\"32\" text=\"진학학교_수정\"/><Cell col=\"33\" text=\"진학학교본분교_수정\"/><Cell col=\"34\" text=\"국가_수정\"/><Cell col=\"35\" text=\"해외진학학교명_수정\"/><Cell col=\"36\" text=\"해외취업회사명_수정\"/><Cell col=\"37\" text=\"해외비자여부_수정\"/><Cell col=\"38\" text=\"해외비자유형_수정\"/><Cell col=\"39\" text=\"해외근무형태_수정\"/><Cell col=\"40\" text=\"교내근무형태_수정\"/><Cell col=\"41\" text=\"시작일/출판일/등록일_수정\"/><Cell col=\"42\" text=\"종료일_수정\"/><Cell col=\"43\" text=\"근무시간_수정\"/><Cell col=\"44\" text=\"공연명/전시회명/도서명/작품명_수정\"/><Cell col=\"45\" text=\"장소/출판사_수정\"/><Cell col=\"46\" text=\"역할/작품명(개인)_수정\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:SCHCD\"/><Cell col=\"2\" text=\"bind:SCHNM\"/><Cell col=\"3\" text=\"bind:ORGCD\"/><Cell col=\"4\" text=\"bind:ORGNM\"/><Cell col=\"5\" text=\"bind:DEPTNM\"/><Cell col=\"6\" text=\"bind:DNNM\"/><Cell col=\"7\" text=\"bind:JOBTYPENM\"/><Cell col=\"8\" text=\"bind:STUDENTNO\"/><Cell col=\"9\" text=\"bind:NAME\"/><Cell col=\"10\" text=\"bind:UNIQUEKEY\"/><Cell col=\"11\" text=\"bind:IMPROPTYN\" displaytype=\"combotext\" combodataset=\"dsImpropt\" combodatacol=\"CDNM\" combocodecol=\"CD\"/><Cell col=\"12\" text=\"bind:IMPROPTYN\"/><Cell col=\"13\" text=\"bind:RTNRN\"/><Cell col=\"14\" text=\"bind:EXCHANGEYN\" combodataset=\"dsYn\" combodatacol=\"CDNM\" combocodecol=\"CD\"/><Cell col=\"15\" text=\"bind:GOSCHNM\"/><Cell col=\"16\" text=\"bind:GOORGNM\"/><Cell col=\"17\" text=\"bind:NACODENM\"/><Cell col=\"18\" text=\"bind:GOFORGSCHNM\"/><Cell col=\"19\" text=\"bind:FORGCOMNM\"/><Cell col=\"20\" text=\"bind:OVERSEAVISAYN\"/><Cell col=\"21\" text=\"bind:OVERSEAVISATYPE\"/><Cell col=\"22\" text=\"bind:OVERSEAWORKTYPE\"/><Cell col=\"23\" text=\"bind:SCHWORKFORMNM\"/><Cell col=\"24\" text=\"bind:STARTDT\"/><Cell col=\"25\" text=\"bind:ENDDT\"/><Cell col=\"26\" text=\"bind:WORKHOUR\"/><Cell col=\"27\" text=\"bind:ARTNM\"/><Cell col=\"28\" text=\"bind:ARTPL\"/><Cell col=\"29\" text=\"bind:ARTPO\"/><Cell col=\"30\" text=\"bind:JOBTYPECD_AT\"/><Cell col=\"31\" text=\"bind:SAMEUNIVYN_AT\"/><Cell col=\"32\" text=\"bind:GOSCHCD_AT\"/><Cell col=\"33\" text=\"bind:GOORGCD_AT\"/><Cell col=\"34\" text=\"bind:NACODE_AT\"/><Cell col=\"35\" text=\"bind:GOFORGSCHNM_AT\"/><Cell col=\"36\" text=\"bind:FORGCOMNM_AT\"/><Cell col=\"37\" text=\"bind:OVERSEAVISAYN_AT\"/><Cell col=\"38\" text=\"bind:OVERSEAVISATYPE_AT\"/><Cell col=\"39\" text=\"bind:OVERSEAWORKTYPE_AT\"/><Cell col=\"40\" text=\"bind:SCHWORKFORM_AT\"/><Cell col=\"41\" text=\"bind:STARTDT_AT\"/><Cell col=\"42\" text=\"bind:ENDDT_AT\"/><Cell col=\"43\" text=\"bind:WORKHOUR_AT\"/><Cell col=\"44\" text=\"bind:ARTNM_AT\"/><Cell col=\"45\" text=\"bind:ARTPL_AT\"/><Cell col=\"46\" text=\"bind:ARTPO_AT\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);

            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,980,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("ad11m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad11m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad11m00.xfdl", function() {
        ...
        this.fv_EVDDOCTYPE = "1"; // 증빙자료
        //페이징
        this.pageRowCnt = 20;
        this.totalRowCnt = 0;
        this.pageFirst = true;

        this.fv_MENUNM = "관리자>자료검증>학교별증빙자료";
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "listJobGroupCd"){
        			...
        			this.dsJobGroupCd.set_filterstr("JOBTYPEGROUPCD !='14' && JOBTYPEGROUPCD !='8' && JOBTYPEGROUPCD !='9' ");
        		...
        		if(serviceID == "listReturnRsn"){
        			...
        			this.utlf_excelDownload("증빙자료-반려사유리스트",this.Div.form.gd_excel,this.Export00_onsuccess);
        		}
        		if(serviceID == "updateRtnRsn"){
        ...
        this.lfn_listPage = function(sPage)
        {
        	...
        	strParam += "IMADYYN="	+ this.Div.form.sub_search.form.in_cb_ady.value 		+ "ª";
        	strParam += "INCHKCNT="	+ this.Div.form.sub_search.form.in_chkcnt.value 		+ "ª";
        ...
        this.ad11m00_onload = function(obj,e)
        {
        	...
        	this.Div.form.sub_search.form.in_chkcnt.set_index(1);
        	this.Div.form.pagingWrap.form.div_pagging.visible=false;
        ...
        //alert("in Import00_onsuccess");
        	this.dsExcel.deleteRow(0);
        	this.dsSaveExcel.clearData();
        //alert("bef loop");
        	for(var i=0; i < this.dsExcel.rowcount; i++){
        		var nRow = this.dsSaveExcel.addRow();
        		this.dsSaveExcel.copyRow(nRow,this.dsExcel,i,"SCHCD=Column1,ORGCD=Column3,UNIQUEKEY=Column10,IMPROPTYN=Column12,RTNRN=Column13");
        ...
        this.btn_return_onclick = function(obj,e)
        {
        	...
        	for(var i=0; i < this.dsMain.rowcount; i++){
        		if(this.dsMain.getColumn(i,"_chk") =="1"){
        			...
        			if(	"12" != this.dsMain.getColumn(i,"SURVPROSTATUSCD")) statusChk = false;
        			trace(this.dsMain.getColumn(i,"TOTALCNT"));
        			trace(this.dsMain.getColumn(i,"SUCCNT"));
        	...
        	*/
        	...
        	this.gfnTransaction("updateRtnRsn",
        						"/swiss/ad/dataVerification/insertAdRtEvdoc.do",
        						"dsSearch=dsSave",
        						"",
        						"",
        						"fnCallback",
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.sub_search.form.in_cb_ady.addEventHandler("onitemchanged",this.Div_sub_search_in_cb_procyn_onitemchanged,this);
        ...
        this.loadIncludeScript("ad11m00.xfdl");
