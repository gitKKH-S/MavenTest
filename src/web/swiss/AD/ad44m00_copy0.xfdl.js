(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"100\"/><Column size=\"250\"/><Column size=\"250\"/><Column size=\"120\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell col=\"0\" text=\"일시\"/><Cell col=\"1\" text=\"대상\"/><Cell col=\"2\" text=\"유형\"/><Cell col=\"3\" text=\"PC\"/><Cell col=\"4\" text=\"로그인ID\"/></Band><Band id=\"body\"><Cell col=\"0\" text=\"bind:CHGDTHM\"/><Cell col=\"1\" text=\"bind:CHGTABLE\"/><Cell col=\"2\" text=\"bind:CHGTYPE\"/><Cell col=\"3\" text=\"bind:CHGPCNAME\"/><Cell col=\"4\" text=\"bind:CHGPCID\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad34m00_copy0.xfdl","CM::common.xjs");
        this.addIncludeScript("ad34m00_copy0.xfdl","CM::utl_script.xjs");
        this.registerScript("ad34m00_copy0.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("ad34m00_copy0.xfdl");
