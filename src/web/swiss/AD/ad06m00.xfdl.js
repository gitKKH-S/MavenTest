(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"SURVSEQ\" type=\"STRING\" size=\"256\"/><Column id=\"SURVKINDCD\" type=\"STRING\" size=\"256\"/><Column id=\"SCHCD\" type=\"STRING\" size=\"256\"/><Column id=\"SCHNM\" type=\"STRING\" size=\"256\"/><Column id=\"ORGCD\" type=\"STRING\" size=\"256\"/><Column id=\"ORGNM\" type=\"STRING\" size=\"256\"/><Column id=\"SURVPROSTATUSDTHM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPTCNT\" type=\"STRING\" size=\"256\"/><Column id=\"GPCNT\" type=\"STRING\" size=\"256\"/><Column id=\"SURVPROSTATUSCD\" type=\"STRING\" size=\"256\"/><Column id=\"rowType\" type=\"STRING\" size=\"256\"/><Column id=\"SURVPROSTATUSNM\" type=\"STRING\" size=\"256\"/><Column id=\"RCEPTCN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"43\"/><Column size=\"89\"/><Column size=\"228\"/><Column size=\"80\"/><Column size=\"138\"/><Column size=\"75\"/><Column size=\"78\"/><Column size=\"142\"/><Column size=\"326\"/></Columns><Rows><Row size=\"45\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"조사기준\"/><Cell col=\"2\" text=\"학교명\"/><Cell col=\"3\" text=\"본분교\"/><Cell col=\"4\" text=\"제출일시\"/><Cell col=\"5\" text=\"학과수\"/><Cell col=\"6\" text=\"졸업자수\"/><Cell col=\"7\" text=\"접수상태\"/><Cell col=\"8\" text=\"수정요청내용\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:SURVPROSTATUSCD == '2'?'checkboxcontrol':SURVPROSTATUSCD == '4'?'checkboxcontrol':SURVPROSTATUSCD == '6'?'checkboxcontrol':'none'\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:SURVSEQ\"/><Cell col=\"2\" text=\"bind:SCHNM\" tooltiptext=\"bind:SCHNM\"/><Cell col=\"3\" text=\"bind:ORGNM\"/><Cell col=\"4\" text=\"bind:SURVPROSTATUSDTHM\" displaytype=\"normal\" calendardateformat=\"yyyy-MM-dd hh:mm\" calendareditformat=\"yyyy-MM-dd hh:mm\" tooltiptext=\"bind:SURVPROSTATUSDTHM\"/><Cell col=\"5\" text=\"bind:DEPTCNT\"/><Cell col=\"6\" text=\"bind:GPCNT\"/><Cell col=\"7\" text=\"bind:SURVPROSTATUSNM\" tooltiptext=\"bind:SURVPROSTATUSNM\"/><Cell col=\"8\" text=\"bind:RCEPTCN\" tooltiptext=\"bind:RCEPTCN\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad06m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad06m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad06m00.xfdl", function() {
        ...
        this.ad06m00_oninit = function(obj,e)
        {
        	this.initGpInfo();
        };
        ...
        */
        	...
        	if(nPos != "0"){
        		if(nPos == "8"){	//수정요청 히스토리
        			...
        			var objParam = {
        				...
        				, UNIGRADECD : this.ds_list.getColumn(nRow,"UNIGRADECD")
        			};
        ...
        this.fnCallback = function(serviceId, errCD, errMSG){
        	if(serviceId == "initGpInfo"){
        		...
        		*/
        		...
        		this.yearChanged();
        		this.searchGpResultCnt();
        	} else if(serviceId == "searchGpResultCnt"){
        		this.totalRowCnt = this.ds_cnt.getColumn(0, "CNT");
        		this.paggingInit();
        		this.searchGpResultList(this.Div.form.pagingWrap.form.div_pagging.form.fv_pageIdx+1);
        	} else if(serviceId == "searchGpResultList"){
        ...
        // 목록
        this.searchGpResultList = function(sPage){
        	var SURVYEAR		= this.Div.form.div_searchArea.form.in_cb_year.value;
        	var SCHKINDCD		= this.Div.form.div_searchArea.form.in_cb_schkind.value;
        	var SCHNM 			= this.Div.form.div_searchArea.form.in_edit_school.value;
        	var SURVPROSTATUSCD	= this.Div.form.div_searchArea.form.in_cb_prostatus.value;
        	...
        	dsParamSetArrowBlank(this.ds_search, strParam);
        	this.gfnTransaction("searchGpResultList",
        						"swiss/ad/progress/searchGpResultList.do",
        						"dsSearch=ds_search",
        						"ds_list=dsResult",
        						"",
        						"fnCallback",
        ...
        {
        	this.utlf_excelDownload("졸업생연계결과", this.Div.form.gd_list, this.Export00_onsuccess);
        };
        ...
        {
            this.addEventHandler("oninit",this.ad06m00_oninit,this);
        ...
        this.loadIncludeScript("ad06m00.xfdl");
