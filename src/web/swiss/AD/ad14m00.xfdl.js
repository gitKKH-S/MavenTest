(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("in_cb_00","Static00:10","20","240","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_proc","in_cb_00:108","20","100","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("1");
            obj.set_text("검증");
            obj.set_cssclass("btn_styLarge");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Button("btn_verirst","btn_proc:20","20","100","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("3");
            obj.set_text("검증내역저장");
            obj.set_cssclass("btn_styLarge");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Grid("gd_00","30","154","1200","660",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            ...
            obj = new Grid("gd_01","515","gd_00:-273","670","170",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"126\"/><Column size=\"150\"/><Column size=\"129\"/><Column size=\"133\"/><Column size=\"200\"/><Column size=\"111\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"300\"/><Column size=\"300\"/><Column size=\"300\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"순번\" color=\"#000000\"/><Cell col=\"1\" text=\"검증번호\" color=\"#000000\"/><Cell col=\"2\" text=\"조사기준\" color=\"#000000\"/><Cell col=\"3\" text=\"조사종류\" color=\"#000000\"/><Cell col=\"4\" text=\"학교코드\" color=\"#000000\"/><Cell col=\"5\" text=\"학교\" color=\"#000000\"/><Cell col=\"6\" text=\"본분교코드\" color=\"#000000\"/><Cell col=\"7\" text=\"본분교\" color=\"#000000\"/><Cell col=\"8\" text=\"학과\" color=\"#000000\"/><Cell col=\"9\" text=\"학번\" color=\"#000000\"/><Cell col=\"10\" text=\"검증번호\" color=\"#000000\"/><Cell col=\"11\" text=\"검증내용\" color=\"#000000\"/><Cell col=\"12\" text=\"검증컬럼\" color=\"#000000\"/><Cell col=\"13\" text=\"컬럼내용\" color=\"#000000\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" checkboxtruevalue=\"1\" text=\"expr:currow+1\" color=\"#595959\"/><Cell col=\"1\" text=\"bind:VERINO\" color=\"#595959\"/><Cell col=\"2\" text=\"bind:SURVSEQ\" color=\"#595959\"/><Cell col=\"3\" text=\"bind:SURVKINDCD\" color=\"#595959\"/><Cell col=\"4\" text=\"bind:SCHCD\" color=\"#595959\"/><Cell col=\"5\" text=\"bind:SCHNM\" color=\"#595959\"/><Cell col=\"6\" text=\"bind:ORGCD\" color=\"#595959\"/><Cell col=\"7\" text=\"bind:ORGNM\" color=\"#595959\"/><Cell col=\"8\" text=\"bind:DEPTNM\" color=\"#595959\"/><Cell col=\"9\" text=\"bind:STUDENTNO\" color=\"#595959\"/><Cell col=\"10\" text=\"bind:VERINO\" color=\"#595959\"/><Cell col=\"11\" text=\"bind:MESSAGE\" textAlign=\"left\" color=\"#595959\"/><Cell col=\"12\" text=\"bind:COLUMN_NAME\" color=\"#595959\"/><Cell col=\"13\" text=\"bind:COLUMN_INFO\" textAlign=\"center\" color=\"#595959\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad14m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad14m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad14m00.xfdl", function() {
        this.executeIncludeScript("CM::common.xjs"); /*include "CM::common.xjs"*/;
        this.executeIncludeScript("CM::utl_script.xjs"); /*include "CM::utl_script.xjs"*/;
        this.fv_USERID ="";
        this.fv_SURVSEQ="";
        this.fv_SURVKINDCD="FP";

        this.fv_MENUNM = "관리자>형식검증>신입생정보";
        ...
        this.ad14m00_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.ad14m00_onload,this);
        ...
        this.loadIncludeScript("ad14m00.xfdl");
