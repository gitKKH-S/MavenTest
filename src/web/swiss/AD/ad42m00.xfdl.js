(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sub_title","0",null,"260","32",null,"2",null,null,null,null,this.Div.form.sub_title_wrap.form);
            obj.set_taborder("0");
            obj.set_text("취업담당자 관리");
        ...
        this.fv_MENUNM = "관리자>시스템관리>취업담당자관리";
        ...
        this.ad32m00_onload = function(obj,e)
        {
        	var objApp 		= nexacro.getApplication();
        ...
        this.selectKediUser = function(){
        	...
        	this.gfnTransaction("selectKediUser",
        						"/swiss/ad/user/selectSchoolUserList.do",
        						"dsSearch=dsSearch",
        ...
        {
            this.addEventHandler("onload",this.ad32m00_onload,this);
