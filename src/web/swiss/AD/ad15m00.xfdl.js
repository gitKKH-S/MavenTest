(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("in_cb_00","Static00:20","20","240","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_proc","in_cb_00:106","20","100","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("1");
            obj.set_text("검증");
        ...
        // User Script
        this.addIncludeScript("ad15m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad15m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad15m00.xfdl", function() {
        ...
        this.ad15m00_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.ad15m00_onload,this);
        ...
        this.loadIncludeScript("ad15m00.xfdl");
