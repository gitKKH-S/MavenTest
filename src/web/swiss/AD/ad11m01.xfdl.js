(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_sch","800","10","80","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("9");
            obj.set_text("검색");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Static("Static00_01_00_00_01","26","60","80","35",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("10");
            obj.set_text("개인 식별키");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_01_00_00_00_00_00","419","110","65","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("14");
            obj.set_text("제출여부");
            this.Div.form.sub_search.addChild(obj.name, obj);

            obj = new Combo("in_cb_ady","509","110","280","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("15");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Div("Div02","647","305","580","292",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("Static00_00_00_01","306","-188","70","32",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("18");
            obj.set_text("학번");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("label_stno","394","-188","180","32",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("19");
            this.Div02.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"120\"/><Column size=\"70\"/><Column size=\"237\"/><Column size=\"48\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"129\"/></Rows><Band id=\"head\"><Cell text=\"적합여부\"/><Cell col=\"1\" text=\"파일명\"/><Cell col=\"2\" text=\"페이지\"/><Cell col=\"3\" text=\"반려사유\"/><Cell col=\"4\" text=\"저장\"/></Band><Band id=\"body\"><Cell text=\"bind:IMPROPTYN\" combodataset=\"dsYn\" combodatacol=\"CDNM\" combocodecol=\"CD\" edittype=\"none\" displaytype=\"combotext\"/><Cell col=\"1\" text=\"bind:REAL_FILE_NAME\" cursor=\"pointer\" tooltiptext=\"bind:REAL_FILE_NAME\"/><Cell col=\"2\" text=\"bind:PAGENO\"/><Cell col=\"3\" text=\"bind:RTNRN\" edittype=\"textarea\" displaytype=\"textareacontrol\" tooltiptext=\"bind:RTNRN\"/><Cell col=\"4\" text=\"bind:DOWN_LINK\" tooltiptext=\"bind:DOWN_LINK\" cursor=\"pointer\"/></Band></Format></Formats>");
            this.Div03.addChild(obj.name, obj);

            obj = new Radio("in_rdo_00","19","167","339","47",null,null,null,null,null,null,this.Div03.form);
            obj.set_taborder("1");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Button("btn_save","357","172","100","30",null,null,null,null,null,null,this.Div03.form);
            obj.set_taborder("2");
            obj.set_text("저장");
            this.Div03.addChild(obj.name, obj);

            obj = new Button("btn_update","467","172","100","30",null,null,null,null,null,null,this.Div03.form);
            obj.set_taborder("3");
            obj.set_text("내용변경");
            ...
            obj = new BindItem("item0","Div02.form.label_jobnm","text","dsMain","JOBTYPENM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","Div02.form.label_SEXNM","text","dsMain","SEXNM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","Div02.form.label_SCHNM","text","dsMain","SCHNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","Div02.form.label_ORGNM","text","dsMain","ORGNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","Div02.form.label_COLNM","text","dsMain","COLNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","Div02.form.label_DEPTNM","text","dsMain","DEPTNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","Div02.form.label_DNNM","text","dsMain","DNNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","Div02.form.label_name","text","dsMain","NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","Div02.form.label_stno","text","dsMain","STUDENTNO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","Div02.form.label_STNO","text","dsMain","STUDENTNO");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("ad11m01.xfdl","CM::common.xjs");
        this.addIncludeScript("ad11m01.xfdl","CM::utl_script.xjs");
        this.registerScript("ad11m01.xfdl", function() {
        ...
        this.fv_MENUNM = "관리자>자료검증>개인별증빙자료";
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "listSchEvdocFile"){
        			var EXCHANGEYN = this.dsMain.getColumn(this.dsMain.rowposition,"EXCHANGEYN");
        			if("1"==EXCHANGEYN) EXCHANGEYN="예";
        			else if("2"==EXCHANGEYN) EXCHANGEYN="아니요";
        			//trace(EXCHANGEYN);
        			this.Div02.form.label_EXCHANGEYN.set_text(EXCHANGEYN);
        			//if(this.dsEvdocfile.rowcount == 0) alert("조회된 자료가 없습니다.");
        			//this.gd_sub_oncellclick(this.Div03.form.gd_sub,"1");
        			if("12"!=this.dsMain.getColumn(this.dsMain.rowposition,"SURVPROSTATUSCD")){
        				//alert("증빙자료 처리 단계가 아닙니다.");
        ...
        this.Div_sub_search_Static00_01_00_00_00_00_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.sub_search.form.Static00_01_00_00_00_00.addEventHandler("onclick",this.Div_sub_search_Static00_01_00_00_00_00_onclick,this);
        ...
        this.loadIncludeScript("ad11m01.xfdl");
