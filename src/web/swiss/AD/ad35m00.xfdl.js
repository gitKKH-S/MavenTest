(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("sub_search","30","60","1200","80",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("3");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"일시\"/><Cell col=\"1\" text=\"유형\"/><Cell col=\"2\" text=\"이전ID\"/><Cell col=\"3\" text=\"담당자구분\"/><Cell col=\"4\" text=\"유저ID\"/><Cell col=\"5\" text=\"학교\"/><Cell col=\"6\" text=\"본분교\"/><Cell col=\"7\" text=\"이름\"/><Cell col=\"8\" text=\"전화번호\"/><Cell col=\"9\" text=\"휴대폰\"/><Cell col=\"10\" text=\"이메일\"/><Cell col=\"11\" text=\"SMS\"/><Cell col=\"12\" text=\"활성화여부\"/></Band><Band id=\"body\"><Cell text=\"bind:CHGDTHM\"/><Cell col=\"1\" text=\"bind:OLDUSERID\"/><Cell col=\"2\" text=\"bind:LOGTYPE\"/><Cell col=\"3\" text=\"bind:USERGRPTYPE\"/><Cell col=\"4\" text=\"bind:USERID\"/><Cell col=\"5\" text=\"bind:SCHNM\"/><Cell col=\"6\" text=\"bind:ORGNM\"/><Cell col=\"7\" text=\"bind:USERNM\"/><Cell col=\"8\" text=\"bind:TELNO\"/><Cell col=\"9\" text=\"bind:MOBILENO\"/><Cell col=\"10\" text=\"bind:EMAILADDR\"/><Cell col=\"11\" text=\"bind:SMSYN\"/><Cell col=\"12\" text=\"bind:WORKYN\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ad35m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ad35m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ad35m00.xfdl", function() {
        ...
        this.fv_MENUNM = "관리자>시스템관리>사용자이력관리";
        ...
        */
        ...
        this.ad35m00_onload = function(obj,e)
        {
        ...
        this.selectWebLogList = function(){
        	...
        	*/
        	...
        	this.gfnTransaction("selectUSERHistoryList",
        						"/swiss/ad/system/selectUSERHistoryList.do",
        						"dsSearch=dsSearch",
        ...
        {
        	this.utlf_excelDownload("사용자이력관리", this.Div.form.gd_main, this.Export00_onsuccess);
        };
        ...
        {
            this.addEventHandler("onload",this.ad35m00_onload,this);
            ...
            this.Div.form.gd_main.addEventHandler("oncelldblclick",this.Div_gd_list_oncellclick,this);
        };

        this.loadIncludeScript("ad35m00.xfdl");
