...
<%
	...
	chkIP = Inet4Address.getLocalHost().getHostAddress();
	
	String AllowedIP[] = { "127.0.0.1", "10.100.52.107" };
	int i;
	int iOk = 0;
	for( i = 0; i < AllowedIP.length; i++ ) {
	     if( AllowedIP[ i ].equals(chkIP) ){
	         iOk = 1;
	         break;
	     }
	}
...
<head>
    ...
    <style id="userfont">
        @font-face {
          ...
          src : url(./_resource_/_font_/SpoqaHanSansRegular.eot);
          src : url(./_resource_/_font_/SpoqaHanSansRegular.eot?#iefix) format('embedded-opentype'),
            url(./_resource_/_font_/SpoqaHanSansRegular.woff2) format('woff2'),
            url(./_resource_/_font_/SpoqaHanSansRegular.woff) format('woff'),
            url(./_resource_/_font_/SpoqaHanSansRegular.ttf) format('truetype');
        }
        @font-face {
          ...
          src : url(./_resource_/_font_/SpoqaHanSansLight.eot);
          src : url(./_resource_/_font_/SpoqaHanSansLight.eot?#iefix) format('embedded-opentype'),
            url(./_resource_/_font_/SpoqaHanSansLight.woff2) format('woff2'),
            url(./_resource_/_font_/SpoqaHanSansLight.woff) format('woff'),
            url(./_resource_/_font_/SpoqaHanSansLight.ttf) format('truetype');
        }
        @font-face {
          ...
          src : url(./_resource_/_font_/SpoqaHanSansBold.eot);
          src : url(./_resource_/_font_/SpoqaHanSansBold.eot?#iefix) format('embedded-opentype'),
            url(./_resource_/_font_/SpoqaHanSansBold.woff2) format('woff2'),
            url(./_resource_/_font_/SpoqaHanSansBold.woff) format('woff'),
            url(./_resource_/_font_/SpoqaHanSansBold.ttf) format('truetype');
        }
        </style>
    ...
    <script src="./nexacro17lib/component/Chart/GraphicsChart.js"></script>
    <script src="./nexacro17lib/component/Chart/ChartBase.js"></script>
    <script src="./nexacro17lib/component/Chart/BasicChart.js"></script>
    <script src="./nexacro17lib/component/Chart/BubbleChart.js"></script>
    <script src="./nexacro17lib/component/Chart/PieChart.js"></script>
    <script src="./nexacro17lib/component/Chart/GaugeChart.js"></script>
    <script src="./nexacro17lib/component/Chart/RadarChart.js"></script>
    <script src="./nexacro17lib/component/Chart/RoseChart.js"></script>
    <script src="./nexacro17lib/component/Chart/FloatChart.js"></script>
    <script src="./nexacro17lib/component/Chart/PyramidChart.js"></script>
...
<%
	if( iOk == 0){
		String val_formname = request.getParameter("formname");
		
		//out.print("["+val_formname+"]");
%>
		<script>
			//alert(2);
			var chkVal = "HP::hp08m00_test.xfdl";
			//alert(3);
			...
			if(chkVal=="HP::hp08m00_test.xfdl"){
...
%>
	<script>
		function oninitframework()
		{
			...
			var screeninfo = [
            {"id":"Desktop_screen","type":"desktop","filesecurelevel":"all","themeid":"theme::default","xadl":"App_Desktop.xadl.quickview.js"}
			];
