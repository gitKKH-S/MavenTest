(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("졸업생인적정보 수정 사유");
            ...
            obj.set_taborder("3");
            obj.set_text("졸업생정보 조사 학과정보 수정사유 등록");
            ...
            obj = new Edit("SCHCD","712","555","57","26",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("cls_edt_base01");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("ORGCD","792","555","57","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("cls_edt_base01");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("gp03p00_copy0.xfdl", function() {
        this.fv_MENUNM = "";
        this.fv_SURVSEQ = "";
        this.fv_SURVKINDCD = "";
        ...
        this.btnFileDown_onclick = function(obj,e){
        	...
        	*/
        	...
        	this.ds_fileDownList.setColumn(nRow, "SAVE_PATH", downUrl );
         	this.ds_fileDownList.setColumn(nRow, "SAVE_FILE_NAME", "GPrequestForm.xlsx");
         	this.ds_fileDownList.setColumn(nRow, "REAL_FILE_NAME", "졸업생정보_수정서식.xlsx");
        ...
        this.loadIncludeScript("gp03p00_copy0.xfdl");
