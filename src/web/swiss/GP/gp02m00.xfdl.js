(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("gp02m00.xfdl","CM::common.xjs");
        this.addIncludeScript("gp02m00.xfdl","CM::utl_script.xjs");
        this.addIncludeScript("gp02m00.xfdl","CM::utl_modal.xjs");
        this.registerScript("gp02m00.xfdl", function() {
        ...
        this.btn_save_onclick = function(obj,e)
        {
        	...
        	//alert("cur userid="+this.fv_USERID);
        	...
        	if(this.Div.form.PROCTYPE.value == "I"){
        		...
        		if(this.Div.form.Div00.form.USERID.value == this.fv_USERID){
        			alert("현재 사용중인 사용자ID를 전산담당자로 등록할 수 없습니다.");
        			this.Div.form.Div00.form.USERID.setFocus();
        			return;
        		}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.tableTitle.addEventHandler("onclick",this.Div_tableTitle_onclick,this);
        ...
        this.loadIncludeScript("gp02m00.xfdl");
