(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("gp06m00.xfdl","CM::common.xjs");
        this.addIncludeScript("gp06m00.xfdl","CM::utl_script.xjs");
        this.addIncludeScript("gp06m00.xfdl","CM::utl_modal.xjs");
        this.registerScript("gp06m00.xfdl", function() {
        ...
        this.loadIncludeScript("gp06m00.xfdl");
