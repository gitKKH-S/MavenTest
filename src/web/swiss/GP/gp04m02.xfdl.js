(function()
{
    return function()
    {
        ...
        {
            this.set_name("ag05m02");
            this.set_titletext("New Form");
            this.set_cssclass("frameCont");
            this.set_border("0px");
            if (Form == this.constructor)
            {
                this._setFormPosition(1260,1200);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"USERGRPTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"SURVSEQ\" type=\"STRING\" size=\"256\"/><Column id=\"SURVKINDCD\" type=\"STRING\" size=\"256\"/><Column id=\"USERID\" type=\"STRING\" size=\"256\"/><Column id=\"CHGPSNYN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("sub_search","30","197","1200","155",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btn_search","945","110","160","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("6");
            obj.set_text("검색");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Combo("in_cb_00","Static00:18","10","280","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("in_cb_05","Static00_01_01:16","60","280","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("in_edit_01","Static00_01_00_00:26","110","280","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("4");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Edit("in_edit_02","Static00_01_00_00_00:15","60","280","30",null,null,null,null,null,null,this.Div.form.sub_search.form);
            obj.set_taborder("5");
            this.Div.form.sub_search.addChild(obj.name, obj);
            ...
            obj = new Button("btn_savefile","30","365","125","40",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("7");
            obj.set_text("파일저장");
            obj.set_cssclass("btn_sty04");
            this.Div.addChild(obj.name, obj);

            obj = new Grid("gd_00","30","412","798","525",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            ...
            obj = new Grid("gd_01","417","gd_00:-255","398","210",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("8");
            obj.set_cssclass("grid_sty02");
            ...
            obj = new Div("Div02","860","412","370","560",null,null,null,null,null,null,this);
            obj.set_taborder("1");
        ...
        // User Script
        this.addIncludeScript("gp04m02.xfdl","CM::common.xjs");
        this.addIncludeScript("gp04m02.xfdl","CM::utl_script.xjs");
        this.registerScript("gp04m02.xfdl", function() {
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "listIndiAGCode"){
        			...
        			this.fv_CHGPSNYN = this.dsSchool.getColumn(0,"CHGPSNYN");
        ...
        this.ag05m02_onload = function(obj,e)
        {
        ...
        this.lfn_listPage = function(sPage)
        {
        	...
        	if("MANAGER" != this.Div.form.sub_search.form.in_cb_00.value){
        ...
        this.Div_sub_search_onkeydown = function(obj,e)
        {
        ...
        this.lfn_goMenu = function(obj,e)
        {
        	...
        	if("6" == this.fv_USERGRPTYPE){
        		if("ag01m00" !=menuid && "ag03m00" !=menuid
        			&& "ag05m00" !=menuid && "ag08m00" !=menuid ){
        			alert("화면에 대한 권한이 없습니다.");
        			return;
        		}
        		if("ag05m00" == menuid){
        			menuid = "ag05m01";// this.fn_goPage("AG::ag05m01.xfdl");
        		}
        		if("ag08m00" == menuid){
        	...
        	this.fv_EVDDOCKIND = this.dsSchool.getColumn(0,"EVDDOCKIND");
        ...
        {
            this.addEventHandler("onload",this.ag05m02_onload,this);
            ...
            this.Div.form.sub_search.form.in_edit_00.addEventHandler("onkeydown",this.Div_sub_search_onkeydown,this);
            this.Div.form.sub_search.form.in_edit_01.addEventHandler("onkeydown",this.Div_sub_search_onkeydown,this);
            this.Div.form.sub_search.form.in_edit_02.addEventHandler("onkeydown",this.Div_sub_search_onkeydown,this);
        ...
        this.loadIncludeScript("gp04m02.xfdl");
