(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("ag08p01.xfdl","CM::utl_script.xjs");
        this.registerScript("ag08p01.xfdl", function() {
        ...
        */
        ...
        this.ag08p01_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.ag08p01_onload,this);
        ...
        this.loadIncludeScript("ag08p01.xfdl");
