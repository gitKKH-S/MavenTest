(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_image("url(\'theme::default/images/img_researchTop03.jpg\')");
            ...
            obj.set_color("#cc2f00");
            this.Div.form.Div00.addChild(obj.name, obj);

            obj = new Static("Static01","469","37","400","33",null,null,null,null,null,null,this.Div.form.Div00.form);
            obj.set_taborder("1");
            ...
            obj.set_image("url(\'theme::default/images/reser_table03.png\')");
            this.Div.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer01","30","600","1200","180",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_background("transparent");
            obj.set_image("url(\'theme::default/images/reser_visual03.jpg\')");
            this.Div.addChild(obj.name, obj);

            obj = new Static("Static03","1070","Div00:0","30","13",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            obj.set_background("url(\'theme::default/images/reser_bul03.png\') no-repeat");
            this.Div.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ag00m00.xfdl","CM::common.xjs");
        this.registerScript("ag00m00.xfdl", function() {
        //include "CM::js/common.xjs";
        ...
        this.loadIncludeScript("ag00m00.xfdl");
