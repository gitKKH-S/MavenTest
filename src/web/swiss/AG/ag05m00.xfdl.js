(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_goIndi","1018","430","100","30",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("11");
            obj.set_text("◀ 개별등록");
        ...
        // User Script
        this.addIncludeScript("ag05m00.xfdl","CM::common.xjs");
        this.addIncludeScript("ag05m00.xfdl","CM::utl_script.xjs");
        this.registerScript("ag05m00.xfdl", function() {
        ...
        //	////trace(this.dsSearch.saveXML());
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "조사서식", strParam);  //접속기록
        	this.gfnTransaction("listAGinfo",
        ...
        this.btn_02_onclick = function(obj,e)
        {
        	...
        	this.ds_fileDownList.setColumn(nRow, "SAVE_PATH", downUrl );
         	this.ds_fileDownList.setColumn(nRow, "SAVE_FILE_NAME", "AGsurvCode.hwp");
         	this.ds_fileDownList.setColumn(nRow, "REAL_FILE_NAME", "취업구분항목코드.hwp");
        ...
        this.Div_btn_goIndi_onclick = function(obj,e)
        {
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "개별등록", "");  //접속기록
        	this.fn_goPage("AG::ag05m01.xfdl");
        };
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.btn_goIndi.addEventHandler("onclick",this.Div_btn_goIndi_onclick,this);
        };

        this.loadIncludeScript("ag05m00.xfdl");
