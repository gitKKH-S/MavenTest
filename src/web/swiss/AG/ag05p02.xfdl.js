(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsNation", this);
            obj._setContents("<ColumnInfo><Column id=\"CD\" type=\"STRING\" size=\"32\"/><Column id=\"NACONTINENT\" type=\"STRING\" size=\"32\"/><Column id=\"RNUM\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"SURVSEQ\" type=\"STRING\" size=\"32\"/><Column id=\"CDENGNM\" type=\"STRING\" size=\"32\"/><Column id=\"SURVKINDCD\" type=\"STRING\" size=\"32\"/><Column id=\"CDNM\" type=\"STRING\" size=\"32\"/><Column id=\"_chk\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("7");
            obj.set_binddataset("dsNation");
            obj.set_autofittype("col");
            obj.set_cssclass("grid_pdShort,grid_sty04");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"289\"/><Column size=\"289\"/><Column size=\"290\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"대륙구분\"/><Cell col=\"2\" text=\"국가명\"/><Cell col=\"3\" text=\"국가영문명\"/></Band><Band id=\"body\"><Cell text=\"bind:_chk\" displaytype=\"checkboxcontrol\" checkboxtruevalue=\"1\"/><Cell col=\"1\" text=\"bind:NACONTINENT\" cssclass=\"alignLeft\"/><Cell col=\"2\" text=\"bind:CDNM\" cssclass=\"alignLeft\"/><Cell col=\"3\" text=\"bind:CDENGNM\" cssclass=\"alignLeft\"/></Band></Format></Formats>");
            this.Div.addChild(obj.name, obj);
            ...
            obj.set_taborder("4");
            obj.set_innerdataset("dsNationGrp");
            obj.set_datacolumn("NACONTINENT");
            obj.set_codecolumn("NACONTINENTCD");
        ...
        // User Script
        this.registerScript("ag05p02.xfdl", function() {
        ...
        this.fv_MENUNM = "졸업후상황>정보등록(개별)>국가팝업";
        ...
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "listNation"){

        			//trace(this.dsNation.saveXML());
        			//this.Div.form.in_cb_00.set_index(0);
        			this.dsNation.addColumn("_chk","string",1);
        			//trace(this.dsNation.saveXML());
        			this.totalRowCnt = this.dsPage.getColumn(0, "TOTALPAGECNT");

        			if(this.pageFirst)this.paggingInit();
        		}
        		if(serviceID == "listNationGrp"){
        			this.dsNationGrp.insertRow(0);
        			this.dsNationGrp.setColumn(0,"NACONTINENTCD","");
        			this.dsNationGrp.setColumn(0,"NACONTINENT","전체");

        			//trace(this.dsNationGrp.saveXML());
        			this.Div.form.in_cb_00.set_index(0);
        		}

         	}
        }
        this.gp05p02_onload = function(obj,e)
        {
        ...
        this.lfn_selectSearchCdList = function()
        {
        	...
        	this.gfnTransaction("listNationGrp",
        						"/swiss/ag/regist/listNationGrp.do",
        						"dsSearch=dsSearch",
        						"dsNationGrp=dsNationGrp",
        						"",
        						"fnCallback",
        						false);
        };
        ...
        this.lfn_listPage = function(sPage)
        {
        	...
        	strParam += "SURVSEQ="		+ this.fv_SURVSEQ	+ "ª";
        	strParam += "SURVKINDCD="	+ this.fv_SURVKINDCD	+ "ª";
        	strParam += "NACONTINENT="	+ this.Div.form.in_cb_00.value		+ "ª";
        	strParam += "CDNM="			+ this.Div.form.in_edit_00.value	+ "ª";

        	dsParamSetArrowBlank(this.dsSearch, strParam);
        	//trace(this.dsSearch.saveXML());
        	this.setAccessLog(this.fv_SURVSEQ, this.fv_SURVKINDCD, this.fv_MENUNM, "검색", strParam);  //접속기록
        	this.gfnTransaction("listNation",
        						"/swiss/ag/regist/listNation.do",
        						"dsSearch=dsSearch",
        						"dsNation=dsNation dsPage=dsPage",
        						"",
        						"fnCallback",
        						false);
        };
        ...
        {
        	for(var i=0; i < this.dsNation.rowcount; i++){
        		this.dsNation.setColumn(i, "_chk", "");
        	}
        	this.dsNation.setColumn(this.dsNation.rowposition, "_chk",'1');
        };
        ...
        this.Div_btn_00_onclick = function(obj,e)
        {
        	var cntChk=0;
        	for(var i=0; i < this.dsNation.rowcount; i++){
        		if(this.dsNation.getColumn(i, "_chk")=="1")
        			cntChk++;
        	}
        	if(cntChk < 1) { this.alert("국가를 선택해 주세요"); return;}

            var cd = this.dsNation.getColumn(this.dsNation.rowposition, "CD");
            var cdnm = this.dsNation.getColumn(this.dsNation.rowposition, "CDNM");
        	this.opener.fn_set_oversea(cd,cdnm);
        	this.close();
        };
        ...
        {
            this.addEventHandler("onload",this.gp05p02_onload,this);
        ...
        this.loadIncludeScript("ag05p02.xfdl");
