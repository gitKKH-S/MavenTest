...
<script src="js/views/prediction.js?v=1111"></script>
    ...
    <div class="contentWrapper">
        ...
        <div class="formWrapper">
            ...
            <div class="refreshBox">
                ...
                <span style="cursor: pointer;" v-on:click="handleInit">전체초기화</span>
            </div>
            ...
            <div class="formFooter">
                <div class="favoriteBox">
                    <div class="favoriteBtn" v-show="isUserGroup" style="display:none">
                        <img :src="imageSource" alt="favorite" v-on:click="toggleCheckBookmark" style="cursor: pointer;">
        ...
        <div class="modalPage5" v-show="isManualStep5">
            ...
            <div class="alignModal5 colBox">
                <div class="sampleSearchBtnBox colBox">
                    <div class="searchBtn setCenter" style="align-items: center;justify-content: center;">예측</div>
                    <div class="sampleTextBox4">
                        조건 선택 후
                        <span class="blueSpan">예측 버튼 클릭 시</span> 조건에 맞는 결과가 조회 됩니다.
                    </div>
                </div>

                <div class="favorite howTo" v-show="isUserGroup">
                    <div class="sampleTextBox2 howTo" style="text-align: right;">
                        버튼을 누르고 예측하면 <span class="blueSpan">입력한 데이터</span>가 저장됩니다.
                        <br/>
                        저장한 데이터는 우측 상단의 <span class="blueSpan">즐겨찾기</span>에서 확인 가능합니다.
                    </div>
