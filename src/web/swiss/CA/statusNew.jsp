...
<head>
    ...
    <script type="text/javascript" src="js/views/statusNew.js?ver=4"></script>
</head>
    ...
    <div class="totalWrapper paper" id="app" v-show="isMounted" style="display:none;">
        ...
        <div class="headerWrapper no-print">
            ...
            <div class="rBtnWrapper">
                ...
                <a v-on:click.prevent="showModal_usingStatisticsDownloads('false')" v-show="isUserGroup">
        ...
        <div class="searchWrapper" id="module0">
            <div class="tagHeader">
                ...
                <button class="resetBtn setCenter no-print" v-on:click="handleInit">
                    ...
                    <div class="flexBox">
                        <div class="searchBoxWrapper">
                            <div class="compNameSearchBar">
                                <input placeholder="회사명을 입력해주세요." v-model="companySearch"
                            ...
                            <div class="CompanySearchTextDropDown" v-show="isCompanyResultOpen">
                                <virtual-list v-bind:size="12" v-bind:remain="25" style="height: auto; max-height: 300px;">
                                    <ul>
                                        <li class="CompanySearchTextItems" v-for="(cmpname, i) in companySearchResults">
                                            <input class="CompanySearchTextDropDownItem" type="button" aria-label="companyName"
                                                v-model="cmpname.text"
                                                v-on:click="selectCompanyFromTextSearchingList(cmpname.text, cmpname.value)" />
                                        </li>
                                    </ul>
                                </virtual-list>
                            </div>
            ...
            <div class="downloadModalStatus">
                <div class="downloadModalHeader">
                    <div class="flexBox3">
                        ...
                        <div class="downloadModalClose" v-on:click="showModal_usingStatisticsDownloads(false);">
                    ...
                    <div class="downloadInnerContent">
                        <div class="downloadFlex">
                            ...
                            <select title="구분선택" class="statisticsDownloadType"
                                ...
                                <option v-bind:key="i" v-bind:value="type.value" v-for="(type, i) in usageExporterType"
                        ...
                        <div class="downloadFlex">
                            ...
                            <select title="조회간격" class="statisticsDownloadInterval" v-model="usageExporterDateValue">
                                <option v-bind:value="null_value">선택</option>
                                <option v-bind:key="i" v-bind:value="date.value" v-for="(date, i) in usageExporterDate"
            ...
            <div class="searchModal compSearchByCondModal">
                ...
                <div class="searchModalFooter" v-bind:class="'scrollEnabled'" v-show="isCompanySearched">
                    ...
                    <virtual-list v-bind:size="30" v-bind:remain="10" v-if="0 < companyListSearchResults_length">
                        <div v-for="(lptm, i) in companyListSearchResults" v-bind:key="lptm.value">
        ...
        <div class="searchModalBack compRelListModalBack" v-bind:style="style_compRelListModal">
            <div class="searchModal compSearchByCondModal">
                <div class="searchModalHeader">
                    ...
                    <div><h2>{{ companySearch }}</h2></div>
                    <div>다음은, "기업유형", "산업분류", "기업규모(구간)"이 같은 회사를 평균임금이 비슷한 순서로 나열한 목록입니다.</div>
                </div>
                <!--
                    검색 팝업 꼬리말: "연관 회사 목록"
                -->
                <div class="searchModalFooter" v-bind:class="'scrollEnabled'" v-show="isRelativeCompanyExsist">
                    <div class="searchFooterLine1">
                        <div class="flexBox">
                            <img src="./images/searchIcon.svg" alt="search" width="16" height="16" />
                            <div>연관 회사 검색결과</div>
                    ...
                    <div v-for="(lptm, i) in companyListRelation" v-bind:key="lptm.value">
                        <div class="companyList">
                            <label class="container">
        ...
        <div class="resultWrapper" id="wrap_container"
            v-bind:style="style_resultWrapper">
            <span class="discText" v-bind:style="style_visible_to_usergroup">
                &#x2605 화면에서는 기업이 1000개까지 출력되며, 결과 저장을 하시면 모든 리스트를 볼 수 있습니다.</span>
            <div class="resultTabWrapper">
                ...
                <label class="resultTab no-print" for="dutyInfo" v-on:click="selectTab('dutyInfo')">직무 정보</label>
                ...
                <div id="status_content" v-show="isStatusContent">
                    ...
                    <div class="colWrapper resultContentWrapper">
                            ...
                            <div class="statusWrapper statusRWrapper" style="padding-left: 39px;">
                                ...
                                <div class="statusMajorWrapper" style="margin-bottom: 60px;">
                                    <div class="statusMajorBox" v-if="!isProtection">
                                        ...
                                        <div class="statusMajorBoxInner" v-for="(origin, index) in major_rank" v-bind:key="origin.name">
                                            <div>
                                                <span>{{ index + 1 }}</span>
                                                <div class="statusMajorBoxInnerLine"></div>
                                                <span>{{ origin.name }}</span>
                        ...
                        <div style="display: flex;flex-direction: row;width: 100%;" v-if="isUserGroup">
                            <div style="width: 847px;padding-left: 10px;">
                                ...
                                <div class="statusMajorWrapper" style="gap: 20px;">
                                    <div class="statusMajorBox">
                                        ...
                                        <div class="statusMajorBoxInner" style="width: 256px;" v-for="(origin, index) in job_high_rank" v-bind:key="'job_high_'+origin.text">
                                            <div>
                                                <span>{{ index + 1 }}</span>
                                                <div class="statusMajorBoxInnerLine"></div>
                                                <span>{{ origin.name }}</span>
                                    ...
                                    <div class="statusMajorBox">
                                        ...
                                        <div class="statusMajorBoxInner" style="width: 256px;" v-for="(origin, index) in job_mid_rank" v-bind:key="'job_mid_'+origin.text">
                                            <div>
                                                <span>{{ index + 1 }}</span>
                                                <div class="statusMajorBoxInnerLine"></div>
                                                <span>{{ origin.name }}</span>
                                    ...
                                    <div class="statusMajorBox">
                                        ...
                                        <div class="statusMajorBoxInner" style="width: 256px;" v-for="(origin, index) in job_low_rank" v-bind:key="'job_low_'+origin.text">
                                            <div>
                                                <span>{{ index + 1 }}</span>
                                                <div class="statusMajorBoxInnerLine"></div>
                                                <span>{{ origin.name }}</span>
                        ...
                        <div style="display: flex;flex-direction: column;width: 100%;padding-left: 10px;padding-right: 6px;" v-if="!isUserGroup">
                            <div class="statusTitle statusUTitle">
                                직무
                            </div>
                            <div class="statusMajorWrapper" style="gap: 20px;justify-content: space-between;">
                                <div class="statusMajorBox">
                                    ...
                                    <div class="statusMajorBoxInner" style="width: 347px;" v-for="(origin, index) in job_high_rank" v-bind:key="'job_high_'+origin.text">
                                ...
                                <div class="statusMajorBox">
                                    ...
                                    <div class="statusMajorBoxInner" style="width: 347px;" v-for="(origin, index) in job_mid_rank" v-bind:key="'job_mid_'+origin.text">
                                        <div style="width: 236px;">
                                            <span>{{ index + 1 }}</span>
                                            <div class="statusMajorBoxInnerLine"></div>
                                            <span>{{ origin.name }}</span>
                                ...
                                <div class="statusMajorBox">
                                    ...
                                    <div class="statusMajorBoxInner" style="width: 347px;" v-for="(origin, index) in job_low_rank" v-bind:key="'job_low_'+origin.text">
                                        <div style="width: 236px;">
                                            <span>{{ index + 1 }}</span>
                                            <div class="statusMajorBoxInnerLine"></div>
                                            <span>{{ origin.name }}</span>
                ...
                <div id="companyList_content" v-show="isCompanyListContent">
                    ...
                    <div class="resultContentWrapper resultCompanyPieAndList">
                        ...
                        <div class="compRWrapper">
                            <span>전체</span>
                                <div class="compListBox">
                                    <div v-for="(lptm, i) in company_list" v-bind:key="lptm.value"  v-show="0 < company_list.length"
                    ...
                    <div class="resultContentWrapper">
                        ...
                        <div class="status_summary">
                            ...
                            <div v-else>
                                ...
                                <h2 class="no_companyinfo">조회한 회사의 일부 정보를 찾을 수 없습니다.</h2>
                            </div>
                                    ...
                                    <div class="headerContent">
                                        ...
                                        <div class="deptCategoryButtonWrapper">
                                            <select title="학과대분류" class="univDepts" v-model="selected_dept_upper" v-on:change="handleDeptSelect('upper')">
                                                ...
                                                <option v-for="(lptm, index) in category_dept_upper" v-bind:key="lptm">{{ lptm }}</option>
                                            </select>
                                            <select title="학과중분류" class="univDepts" v-model="selected_dept_mid" v-on:change="handleDeptSelect('mid')">
                                                ...
                                                <option v-for="(lptm, index) in tmp_category_dept_mid" v-bind:key="lptm">{{ lptm }}</option>
                                            </select>
                                            <select title="학과소분류" class="univDepts" v-model="selected_dept_lower" v-on:change="handleDeptSelect('lower')">
                                                ...
                                                <option v-for="(lptm, index) in tmp_category_dept_lower" v-bind:key="lptm">{{ lptm }}</option>
                                            </select>
                                            <div v-show="!isProtection">
                                                <select title="학과분류" class="univDepts" style="height:100%;" v-model="selected_dept_subject" v-on:change="handleDeptSelect('subject')">
                                                    ...
                                                    <option v-for="(lptm, index) in tmp_category_dept_subject" v-bind:key="lptm">{{ lptm }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="expectContentWrapper">
                                ...
                                <div class="flexBox2">
                                    <div class="doChartBox2 doChartBox1">
                                        ...
                                        <div class="donutChartCenterText2"
                                    ...
                                    <div class="resultDataListWrapper">
                                        <div class="resultDataContentWrapper">
                                            <div class="resultDataContent"
                                                ...
                                                v-for="(license, index) in license_list" v-bind:key="license.name"
                                                v-bind:class="(index < 3) ? 'resultDataContentActive' : 'resultDataContent'">
                                                <div>{{ index + 1 }}</div>
                            ...
                            <div class="expectContentWrapper">
                                ...
                                <div class="flexBox2">
                                    <div class="doChartBox2 doChartBox1">
                                        ...
                                        <div v-show="0 < job_low_list.length" class="donutChartCenterText2">TOP 5</div>
                                    </div>
                                    <div class="resultDataListWrapper">
                                        <div class="resultDataContentWrapper">
        ...
        <div class="howModalBack" v-show="isSelectedManual">
            ...
            <div class="modalPage2" v-show="isManualStep2">
                ...
                <div class="sampleTabs" style="margin-top: 128px;">
                    <div class="tabWrapper">
                        <input id="conditionSearch2" type="radio" name="searchTabs2" checked />
                        ...
                        <input id="companySearch_howto" type="radio" name="searchTabs2" />
                        <label class="sampleInactiveTab tabs" for="companySearch2">회사명 검색
            ...
            <div class="modalPage3" v-show="isManualStep3">
                ...
                <div class="sampleTabs" style="margin-top: 128px;">
                    <div class="flexBox">
                        ...
                        <label class="sampleActiveTab tabs" for="conditionSearch3">기업조건별 검색
                    ...
                    <div class="sampleSearchTags">
                        ...
                        <div class="flexBox2 tagsText">
                            <div class="tagsBox">
                                <img src="./images/select-box1.svg" width="170" height="54" />
                                <img src="./images/select-box2.svg" width="170" height="54" />
                                <img src="./images/select-box3.svg" width="170" height="54" />
                                <img src="./images/select-box4.svg" width="170" height="54" />
                                <img src="./images/select-box5.svg" width="170" height="54" />
                                <img src="./images/select-box6.svg" width="170" height="54" />
                                <img src="./images/select-box7.svg" width="170" height="54" />
                            </div>
                ...
                <div class="sampleTabs colBox" style="margin-top: 128px;">
                    ...
                    <div class="compSearchAlign1">
                        ...
                        <div class="compSearchBar flexBox">
                            ...
                            <img class="compSearchArrow" src="./images/share1.svg" />
                        </div>
                    </div>
                    ...
                    <div class="colBox compSearchAlign1 compSearchText2">
                        <span>
                            ...
                            표시된, <span class="blueSpan">회사 목록</span>에서 조회하려는 회사를 선택 할 수  있습니다.</span>
                        </span>
                    </div>
                </div>
            </div>
            <div class="modalPage5"  v-show="isManualStep5">
                ...
                <div class="alignModal5 colBox">
                    <div class="sampleReset flexBox">
                        ...
                        <button class="resetBtn setCenter">
                    ...
                    <div class="sampleSearchBtnBox colBox">
                        ...
                        <div class="searchBtn setCenter">검색</div>
                    </div>
