    ...
    app = new Vue({
        ...
        methods: {
            ...
            getPersonalImpact: function(data) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/swiss/cm/getPersonalImpact.do",
                    dataType: "text",
                    data: data,
                    async: false,
                    success: function(data) {
        ...
        created() {
            ...
            if (userType == "1" || userType == "2" || userType == "8" || userType == "7") {
                ...
                if (this.tmpUniTabs.length != 0) {
					...
					alert('학생의 교과정보를 제공한 학교에서만 사용할 수 있는 화면입니다.');
				}
            }
        },
        watch: {
