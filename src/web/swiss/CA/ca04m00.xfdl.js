(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("ca04m00.xfdl","CM::common.xjs");
        this.registerScript("ca04m00.xfdl", function() {
        this.executeIncludeScript("CM::common.xjs"); /*include "CM::common.xjs"*/;

        //글로벌 데이터셋을 사용하기 위한 objApp
        var objApp = nexacro.getApplication();

        this.ca04m00_oninit = function(obj,e)
        {
        	var param = "";
        	...
        	this.Div.form.webBrower_main.set_url(nexacro.getEnvironment().services["svcBaseUrl"].url + "swiss/CA/university.jsp?"+param);
        };
        ...
        {
            this.addEventHandler("onload",this.ca04m00_onload,this);
            this.addEventHandler("oninit",this.ca04m00_oninit,this);
        };

        this.loadIncludeScript("ca04m00.xfdl");
