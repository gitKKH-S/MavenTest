(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new TextArea("in_txtEdit_00","320","199","690","42",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("label_03","40","210","270","21",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("문서보기후  생성되는 파일 위치");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DocViewer_1014.xfdl", function() {

        this.fnCallback = function(){

        	if("SUCCESS" == this.ds_docInfo.getColumn(0, "CODE")){
        		this.webBrower_00.set_url("http://localhost:8080" + this.ds_docInfo.getColumn(0, "URL"));
        	} else {
        		this.alert(this.ds_docInfo.getColumn(0, "MSG"));
        	}
        }
        ...
        this.loadIncludeScript("DocViewer_1014.xfdl");
