(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("CMSchoolCall.xfdl", function() {
        //기본변수세팅
        this.fv_USERID = "";
        this.fv_SURVSEQ = "";
        this.fv_SURVKINDCD = "";
        ...
        this.grd_school_list_oncelldblclick = function(obj,e)
        {
        	...
        	var objParam = {SCHCD:this.dsSchool.getColumn(this.dsSchool.rowposition,"SCHCD")
        				,SCHNM:this.dsSchool.getColumn(this.dsSchool.rowposition,"SCHNM")
        				,ORGCD:this.dsSchool.getColumn(this.dsSchool.rowposition,"ORGCD")
        				,ORGNM:this.dsSchool.getColumn(this.dsSchool.rowposition,"ORGNM")
        				,UNIGRADENM:this.dsSchool.getColumn(this.dsSchool.rowposition,"UNIGRADENM")
        				};

        	//this.close(objParam);// 창닫기

        	var objChildFrame = new ChildFrame();
        	objChildFrame.init("usr_popup"
        	                  , 0
        					  , 0
        					  , 0
        					  , 0
        					  , null
        					  , null
        					  , "CM::CMSchoolCallUser.xfdl");
        	objChildFrame.set_showtitlebar(false);
        	objChildFrame.set_dragmovetype("all");
        	objChildFrame.set_openalign("center middle");
        	objChildFrame.set_overlaycolor("RGBA(196,196,196,0.5)")

        	//var objParam = {SCHCD:'I',SCHNM:'II',ORGCD:'III',ORGNM:'III',UNIGRADENM:'III'};
        ...
        this.loadIncludeScript("CMSchoolCall.xfdl");
