(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"60\"/><Column size=\"0\"/><Column size=\"0\"/></Columns><Rows><Row size=\"28\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"사용자구분\" border=\"0px none,1px solid #a5a5a5,1px solid #a5a5a5,0px none\"/><Cell col=\"1\" text=\"이름\" border=\"0px none,1px solid #a5a5a5,1px solid #a5a5a5,0px none\"/><Cell col=\"2\" text=\"학교코드\"/><Cell col=\"3\" text=\"본/분교\"/></Band><Band id=\"body\"><Cell text=\"BIND:SCHNM\"/><Cell col=\"1\" text=\"bind:ORGNM\"/><Cell col=\"2\" text=\"BIND:SCHCD\"/><Cell col=\"3\" text=\"BIND:ORGCD\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_search00",null,"17","80","26","150",null,null,null,null,null,this.sub_search.form);
            obj.set_taborder("0");
            obj.set_text("조회");
            obj.set_cssclass("cls_btn_search");
            this.sub_search.addChild(obj.name, obj);

            obj = new Edit("edt_schnm","12","17","154","26",null,null,null,null,null,null,this.sub_search.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.sub_search.addChild(obj.name, obj);

            obj = new Edit("edt_orgnm","182","17","154","26",null,null,null,null,null,null,this.sub_search.form);
            obj.set_taborder("2");
            obj.set_readonly("true");
            this.sub_search.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("CMCallModifyUser.xfdl", function() {
        //기본변수세팅
        this.fv_USERID = "";
        this.fv_SURVSEQ = "";
        this.fv_SURVKINDCD = "";
        ...
        this.loadIncludeScript("CMCallModifyUser.xfdl");
