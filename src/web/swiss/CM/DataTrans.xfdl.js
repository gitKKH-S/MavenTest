(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DataTrans.xfdl", function() {
        /***********************************************************************************
         * SYSTEM      : 중앙그룹 전자입찰시스템
        ...
        this.fn_fileListChk = function(){
        	trace("fn_fileListChk 파일 목록 attIdtNo 3 : " +attIdtNo);
        	trace("onloadChk  : " +onloadChk);
        ...
        this.loadIncludeScript("DataTrans.xfdl");
