(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("TextEditorColorPicker.xfdl","lib::lib_base.xjs");
        this.addIncludeScript("TextEditorColorPicker.xfdl","lib::lib_color.xjs");
        this.registerScript("TextEditorColorPicker.xfdl", function() {
        ...
        this.loadIncludeScript("TextEditorColorPicker.xfdl");
