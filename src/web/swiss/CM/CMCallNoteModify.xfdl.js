(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("in_idx","368","348","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_enable("true");
            ...
            obj = new Edit("in_entrydthm","384","75","160","30",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_enable("true");
            obj.set_visible("true");
            ...
            obj = new Edit("in_modifydthm","384","113","160","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_enable("true");
            obj.set_visible("true");
            obj.set_readonly("true");
            ...
            obj = new Edit("in_modifyusrnm","554","113","160","30",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_enable("true");
            obj.set_visible("true");
            obj.set_readonly("true");
            ...
            obj = new Edit("in_entryusrnm","554","75","160","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_enable("true");
            obj.set_visible("true");
            obj.set_readonly("true");
            ...
            obj = new Edit("in_usrgrpcd","454","348","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_enable("true");
            obj.set_visible("false");
            ...
            obj = new Edit("in_usrgrpnm","540","348","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_enable("true");
            obj.set_visible("false");
            ...
            obj = new Edit("in_schcd","630","348","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_enable("true");
            obj.set_visible("false");
            ...
            obj = new Edit("in_orgcd","720","348","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_enable("true");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("CMCallNoteModify.xfdl", function() {
        //기본변수세팅
        this.fv_USERID = "";
        this.fv_USERNM = "";
        this.fv_SURVSEQ = "";
        ...
        this.CMCallNoteModify_onload = function(obj,e)
        {
        	...
        	this.in_entrydthm.set_value(this.parent.SURVParam[14]);
        	this.in_entryusrnm.set_value(this.parent.SURVParam[15]);
        	this.in_modifydthm.set_value(this.parent.SURVParam[16]);
        	this.in_modifyusrnm.set_value(this.parent.SURVParam[17]);
        };
        ...
        this.loadIncludeScript("CMCallNoteModify.xfdl");
