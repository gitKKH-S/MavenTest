(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("webBrower_00","3","50",null,"830","2",null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("CMRdViewer.xfdl", function() {

        this.CMRdViewer_onload = function(obj,e)
        {
        	var mrdfile= this.parent.param1;
        	...
        	this.webBrower_00.set_url(svcBaseUrl+"ReportingServer/html5/swissReportViewer.jsp?param="+param+"&fnm="+mrdfile);
        };
        ...
        this.webBrower_00_onusernotify = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.CMRdViewer_onload,this);
        ...
        this.loadIncludeScript("CMRdViewer.xfdl");
