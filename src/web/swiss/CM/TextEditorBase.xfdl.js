(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_00","5","6","175","117",null,null,null,null,null,null,this.div_tableLayout.form);
            obj.set_taborder("15");
            ...
            obj.getSetter("scrollbars").set("none");
            obj.set_visible("false");
            obj.set_url("CM::TextEditorColorPicker.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_highlight","817","4","22","22",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.getSetter("position").set("absolute");
            ...
            obj = new Button("btn_linkdel","840","4","22","22",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.getSetter("position").set("absolute");
            ...
            obj = new Button("btn_link","885","0","22","22",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.getSetter("position").set("absolute");
            ...
            obj = new Button("btn_image","863","4","22","22",null,null,null,null,null,null,this);
            obj.set_taborder("25");
        ...
        {
            this._addPreloadList("fdl","CM::TextEditorColorPicker.xfdl");
        };
        
        // User Script
        this.addIncludeScript("TextEditorBase.xfdl","lib::lib_base.xjs");
        this.addIncludeScript("TextEditorBase.xfdl","lib::lib_array.xjs");
        this.addIncludeScript("TextEditorBase.xfdl","lib::lib_color.xjs");
        this.registerScript("TextEditorBase.xfdl", function() {
        ...
        var baseUrl = nexacro.getEnvironment().services["svcBaseUrl"].url;
        var caller = this;
        var emptyHtml = "";
        var brHtml = "";
        ...
        var initConfig = {
        	editor : {
        		// editor.html 의 경로
        		url : baseUrl + "ui/file/richtexteditor/html/editor.html",
        	...
        	image : {
        		...
        		// 허용 가능한 확장자 지정.
        		allowTypes : ["jpg","jpeg","gif","png","bmp", "PNG"],
        ...
        ******************************************************************************/
        ...
        this.RichTextEditor_ontimer = function(obj, e)
        {
        	...
        	if (id == 12345){
        		...
        		try {
        			var info = this.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.returnContent();
        			this.setContent(info);
        		} catch (e){
        			this.setTimer(11, 2000);
        		}
        		this.killTimer(id);
        	} else if (id= 11){
        		try {
        ...
        ******************************************************************************/
        ...
        this.web_editor_onloadcompleted = function(obj, e)
        {
        	if ( obj.url != "about:blank" && obj.url == e.url )
        	{
        		...
        		this.setTimer('10', 4000);				// RichTextEditor_ontimer  이벤트 에서 처리됨
        ...
        */
        ...
        this.setCommandState = function(arg)
        {
        	...
        	//this.btn_link.set_visible(!link);
        	//this.btn_linkdel.set_visible(link);
        ...
        ******************************************************************************/
        ...
        this.div_char_grd_char_onmousemove = function(obj, e)
        {
        	if(e.row > -1)
        	{
        		this.div_char.form.sta_char.set_text(this.ds_char.getColumn(e.row, e.cell));
        	}
        }
        ...
        ******************************************************************************/
        ...
        {
        	this.web_editor.callMethod("setContent", content, true);
        }
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_highlight.addEventHandler("onclick",this.toolbarButton_onclick,this);
            this.btn_linkdel.addEventHandler("onclick",this.toolbarButton_onclick,this);
            this.btn_link.addEventHandler("onclick",this.toolbarButton_onclick,this);
            this.btn_image.addEventHandler("onclick",this.toolbarButton_onclick,this);
        ...
        this.loadIncludeScript("TextEditorBase.xfdl");
