(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("in_edit_sch","Static00_01:16","20","280","30",null,null,null,null,null,null,this.Div.form.Div00.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("gd_00","30","btn_00:10","598","445",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("8");
            ...
            obj = new Div("Div02","647","btn_savefile:10","580","150",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("9");
            obj.set_cssclass("sel_box04");
            obj.set_text("");
            this.Div.addChild(obj.name, obj);

            obj = new Static("Static00_00","30","10","70","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("0");
            obj.set_text("성명");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("label_name","118","10","190","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("1");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","30","50","70","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("2");
            obj.set_text("학번");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("label_01_00","88","50","190","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("3");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00","30","90","70","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("4");
            obj.set_text("취업구분");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("label_01_00_00","88","90","190","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("5");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("label_stno","118","50","190","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("6");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Static("label_jobnm","118","90","190","32",null,null,null,null,null,null,this.Div.form.Div02.form);
            obj.set_taborder("7");
            this.Div.form.Div02.addChild(obj.name, obj);

            obj = new Div("Div03","647","Div02:20","580","280",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("10");
            obj.set_text("");
            obj.set_cssclass("sel_box04");
            this.Div.addChild(obj.name, obj);

            obj = new Grid("gd_sub","0","-2","568","276",null,null,null,null,null,null,this.Div.form.Div03.form);
            obj.set_taborder("0");
            obj.set_cssclass("grid_pdShort,grid_sty04");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"60\"/><Column size=\"120\"/><Column size=\"70\"/><Column size=\"2000\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"42\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"자료구분\"/><Cell col=\"2\" text=\"파일명\"/><Cell col=\"3\" text=\"페이지NO\"/><Cell col=\"4\" text=\"반려사유\" textAlign=\"left\" padding=\"left 30px\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:EVDDOCTYPENM\" edittype=\"none\" displaytype=\"normal\" tooltiptext=\"bind:EVDDOCTYPENM\"/><Cell col=\"2\" text=\"bind:REAL_FILE_NAME\" cursor=\"pointer\" tooltiptext=\"bind:REAL_FILE_NAME\"/><Cell col=\"3\" text=\"bind:PAGENO\"/><Cell col=\"4\" text=\"bind:RTNRN\" edittype=\"text\" displaytype=\"textareacontrol\" tooltiptext=\"bind:RTNRN\" autosizecol=\"limitmax\"/></Band></Format></Formats>");
            ...
            obj = new Static("errorMsg","40","707","1188","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new BindItem("item0","Div.form.Div02.form.label_jobnm","text","dsMain","JOBTYPENM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","Div.form.Div02.form.label_stno","text","dsMain","STUDENTNO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","Div.form.Div02.form.label_name","text","dsMain","NAME");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("rt03m00_copy0.xfdl","CM::common.xjs");
        this.addIncludeScript("rt03m00_copy0.xfdl","CM::utl_script.xjs");
        this.registerScript("rt03m00_copy0.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div.form.Div03.form.gd_sub.addEventHandler("oncellclick",this.gd_sub_oncellclick,this);
        ...
        this.loadIncludeScript("rt03m00_copy0.xfdl");
