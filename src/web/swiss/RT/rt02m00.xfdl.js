(function()
{
    return function()
    {
        ...
        {
            this.set_name("rt02m00");
            this.set_titletext("New Form");
            this.set_cssclass("frameCont");
            this.set_border("0px");
            if (Form == this.constructor)
            {
                this._setFormPosition(1260,265);
            }
            ...
            obj = new Div("Div","0","0","1260","260",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00","0","0","30","250",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("1");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static00_00","1230","0","30","250",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new Button("btn_rpt04",null,"30","232","30","40",null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("2");
            obj.set_text("취업현황(학과)(상세)");
            obj.set_cssclass("btn_sty05");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Button("btn_rpt03","648","30",null,"30","btn_rpt04:30",null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("3");
            obj.set_text("취업현황(학과)(요약)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00","595","20","1","41",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("4");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,265,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("rt02m00.xfdl","CM::common.xjs");
        this.registerScript("rt02m00.xfdl", function() {
        ...
        this.fv_USERGRPTYPE="";
        this.fv_UNIGRADENM="";
        this.fv_MENUNM = "조사결과>최종결과";
        var objApp 		= nexacro.getApplication();
        this.fv_MENUID = "rt02m00";
        	...
        	if(errCD < 0){
        		...
        		//trace(this.dsSurvInfo.saveXML());
        			...
        			if("4" == this.fv_USERGRPTYPE || "5" == this.fv_USERGRPTYPE || "6" == this.fv_USERGRPTYPE ){
        				this.lfn_selectSurvSchList(this.Div.form.Div00.form.in_cb_sruvseq.value);
        			}
        		}
        ...
        this.rt02m00_onload = function(obj,e)
        {
        	this.chkActive();
        ...
        {
        	this.lfn_report("summary/rt04r00","취업현황(요약)");
        };

        this.Div_Div01_btn_rpt02_onclick = function(obj,e){
        	this.lfn_report("detail/rt04r00","취업현황(상세)");
        };
        ...
        {
        	this.lfn_report("summary/rt05r00","취업현황(학과)(요약)");
        };

        this.Div_Div01_btn_rpt04_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt05r00","취업현황(학과)(상세)");
        };
        ...
        {
            this.addEventHandler("onload",this.rt02m00_onload,this);
        ...
        this.loadIncludeScript("rt02m00.xfdl");
