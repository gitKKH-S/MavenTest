(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div01","30","153","1200","90",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_border("1px solid #a5a5a5");
            obj.set_background("#ffffff");
            obj.set_text("");
            ...
            obj = new Button("btn_rpt03","btn_rpt01:30","30","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("1");
            obj.set_text("취업현황(학과)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("rt01m00.xfdl","CM::common.xjs");
        this.registerScript("rt01m00.xfdl", function() {
        ...
        this.fv_MENUID = "rt01m00";
        this.fv_MENUNM = "조사결과>제출결과";
        this.fnCallback = function(serviceID, errCD, errMSG){
        	if(errCD < 0){
        		...
        		if(serviceID == "chkActive"){
        			//alert("rtn chkActive");
        			var chkCnt = this.dsSchool.getColumn(idx, "CNT");
        			if(chkCnt==0){
        				alert("현재 사용이 불가능합니다.");
        				return false;
        			}
        ...
        this.rt01m00_onload = function(obj,e)
        {
        	this.chkActive();
        ...
        {
        	this.lfn_report("summary/rt01r00","취업현황");
        };
        ...
        {
        	this.lfn_report("summary/rt02r00","취업현황(학과)");
        };

        this.Div_Div01_btn_rpt04_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt02r00");
        };
        ...
        {
            this.addEventHandler("onload",this.rt01m00_onload,this);
        ...
        this.loadIncludeScript("rt01m00.xfdl");
