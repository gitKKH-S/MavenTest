(function()
{
    return function()
    {
        ...
        {
            this.set_name("rt07m00");
            this.set_titletext("New Form");
            this.set_cssclass("frameCont");
            this.set_border("0px");
            if (Form == this.constructor)
            {
                this._setFormPosition(1260,305);
            }
            ...
            obj = new Div("Div","0","0","1260","300",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00","0","0","30","295",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("1");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static00_00","1230","0","30","295",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new Div("Div00","30","60","1200","70",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("4");
            ...
            obj = new Div("Div01","30","150","1200","140",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_border("1px solid #a5a5a5");
            obj.set_background("#ffffff");
            obj.set_text("");
            ...
            obj = new Button("btn_rpt01_00_00_00","40","44","180","40",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("8");
            obj.set_text("설립·지역별");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,305,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("rt07m00.xfdl","CM::common.xjs");
        this.registerScript("rt07m00.xfdl", function() {
        ...
        this.fv_USERGRPTYPE="";
        this.fv_UNIGRADENM="";
        this.fv_MENUID = "rt07m00";
        this.fv_MENUNM = "조사결과>비교정보>설립지역";
        ...
        this.rt07m00_onload = function(obj,e)
        {
        	this.chkActive();
        ...
        {
        	this.lfn_report("summary/rt14r00","설립·지역별");
        	//this.lfn_tempImage("1-1");
        };

        this.Div_Div01_btn_rpt02_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt14r00","취업현황");
        };

        this.Div_Div01_btn_rpt03_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt15r00");
        };

        this.Div_Div01_btn_rpt04_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt15r00","유지취업");
        };

        this.Div_Div01_btn_rpt01_1_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt16r00");
        };

        this.Div_Div01_btn_rpt02_1_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt16r00","산업분류");
        };

        this.Div_Div01_btn_rpt03_1_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt17r00");
        };

        this.Div_Div01_btn_rpt04_1_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt17r00","기업규모");
        };

        this.Div_Div01_btn_rpt01_2_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt18r00");
        };

        this.Div_Div01_btn_rpt02_2_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt18r00","기업유형");
        };

        this.Div_Div01_btn_rpt03_2_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt19r00");
        };

        this.Div_Div01_btn_rpt04_2_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt19r00","근무지역");
        };

        this.Div_Div01_btn_rpt01_3_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt20r00");
        };

        this.Div_Div01_btn_rpt02_3_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt20r00","초임급여");
        };

        this.Div_Div01_btn_rpt03_3_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt21r00");
        };

        this.Div_Div01_btn_rpt04_3_onclick = function(obj,e)
        {
        	this.lfn_report("detail/rt21r00","자격증취득");
        };

        // 임시 팝업
        this.lfn_tempImage = function(image)
        {
        		var objFrame = new ChildFrame();
        		var objFrame = new ChildFrame();
        		var objParam = {param1:"/"+image+".png"};

        		objFrame.init( image, null, null, 800, 600);
        		objFrame.set_openalign("center middle");
        		objFrame.set_formurl( "CM::IMGViewer.xfdl" );
        		objFrame.showModal(image ,this.getOwnerFrame() ,objParam );
        };
        ...
        {
            this.addEventHandler("onload",this.rt07m00_onload,this);
            ...
            this.Div.form.Div01.form.btn_rpt01_00_00_00.addEventHandler("onclick",this.Div_Div01_btn_rpt01_onclick,this);
        };

        this.loadIncludeScript("rt07m00.xfdl");
