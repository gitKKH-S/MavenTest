(function()
{
    return function()
    {
        ...
        {
            this.set_name("rt06m00");
            this.set_titletext("New Form");
            this.set_cssclass("frameCont");
            this.set_border("0px");
            if (Form == this.constructor)
            {
                this._setFormPosition(1260,310);
            }
            ...
            obj = new Div("Div","0","0","1260","305",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00","0","0","30","300",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("1");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static00_00","1230","0","30","300",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new Static("sub_title","0","-2","120","32",null,null,null,null,null,null,this.Div.form.sub_title_wrap.form);
            obj.set_taborder("0");
            obj.set_text("기본정보");
            ...
            obj = new Div("Div01","30","Div00:20","1200","140",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("5");
            obj.set_border("1px solid #a5a5a5");
            obj.set_background("#ffffff");
            obj.set_text("");
            ...
            obj = new Button("btn_rpt01","40","30","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("0");
            obj.set_text("총괄(요약)");
            ...
            obj = new Button("btn_rpt02","btn_rpt01:30","30","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("1");
            obj.set_text("총괄(상세)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            ...
            obj = new Button("btn_rpt03","664","30","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("3");
            obj.set_text("5대계열(요약)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Button("btn_rpt04","926","30","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("2");
            obj.set_text("5대계열(상세)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Button("btn_rpt01_1","40","80","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("4");
            obj.set_text("7대계열(요약)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Button("btn_rpt02_1","btn_rpt01_1:30","80","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("5");
            obj.set_text("7대계열(상세)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00","595","30","1","80",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("6");
            obj.set_background("#e4e4e4");
            this.Div.form.Div01.addChild(obj.name, obj);

            obj = new Button("btn_rpt04_1",null,"80","232","30","40",null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("7");
            obj.set_text("소계열(상세)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            ...
            obj = new Button("btn_rpt03_1","664","80","232","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("8");
            obj.set_text("소계열(요약)");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,310,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("rt06m00.xfdl","CM::common.xjs");
        this.registerScript("rt06m00.xfdl", function() {
        ...
        this.fv_USERGRPTYPE="";
        this.fv_UNIGRADENM="";
        this.fv_MENUID = "rt06m00";
        this.fv_MENUNM = "조사결과>기본정보";
        ...
        this.rt06m00_onload = function(obj,e)
        {
        	this.chkActive();
        ...
        {
            this.addEventHandler("onload",this.rt06m00_onload,this);
        ...
        this.loadIncludeScript("rt06m00.xfdl");
