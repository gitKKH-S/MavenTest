(function()
{
    return function()
    {
        ...
        {
            this.set_name("rt05m00");
            this.set_titletext("New Form");
            this.set_cssclass("frameCont");
            this.set_border("0px");
            if (Form == this.constructor)
            {
                this._setFormPosition(1260,320);
            }
            ...
            obj = new Div("Div","0","0","1260","315",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static00","0","0","30","310",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("1");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static00_00","1230","0","30","310",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("2");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            obj.set_textAlign("center");
            ...
            obj = new Button("btn_rpt01","40","30","200","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("1");
            obj.set_text("5-가");
            ...
            obj = new Button("btn_rpt02","btn_rpt01:30","30","200","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("1");
            obj.set_text("5-나");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            ...
            obj = new Button("btn_rpt03","btn_rpt02:30","30","200","30",null,null,null,null,null,null,this.Div.form.Div01.form);
            obj.set_taborder("2");
            obj.set_text("5-다");
            obj.set_cssclass("btn_sty05");
            obj.set_font("normal 14px/normal \"SpoqaHanSans-Regular\",\"맑은 고딕\",\"sans-serif\"");
            ...
            obj = new Static("Static04","40","264","1150","40",null,null,null,null,null,null,this.Div.form);
            obj.set_taborder("6");
            obj.set_text("※ 본 정보공시 장표는 연계시점의 자료이므로 대학알리미의 현행장표와 다를 수 있음.");
            obj.set_font("bold 10pt/normal \"Arial\"");
            this.Div.addChild(obj.name, obj);

            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1260,320,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("rt05m00.xfdl","CM::common.xjs");
        this.registerScript("rt05m00.xfdl", function() {
        ...
        this.fv_UNIGRADENM="";
        this.fv_USERGRPTYPE="";
        this.fv_MENUID = "rt05m00";
        this.fv_MENUNM = "조사결과>정보공시";
        ...
        this.rt05m00_onload = function(obj,e)
        {
        	this.chkActive();
        ...
        {
        	this.lfn_report("summary/rt06r00","5-가");
        };

        this.Div_Div01_btn_rpt02_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt07r00","5-나");
        };

        this.Div_Div01_btn_rpt03_onclick = function(obj,e)
        {
        	this.lfn_report("summary/rt08r00","5-다");
        };
        ...
        {
            this.addEventHandler("onload",this.rt05m00_onload,this);
        ...
        this.loadIncludeScript("rt05m00.xfdl");
